    ...
    final void animate(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
        try {
            if (this.definition != null) {
                SequenceDefinition var13 = this.animationId != -1 && this.anInt2828 == 0 ? SequenceDefinition.getAnimationDefinition(this.animationId) : null;
                ...
                if (var15 != null) {
                    ...
                    var17 = null;
                    if (this.graphicId != -1 && -1 != this.anInt2805) {
                        GraphicDefinition var21 = GraphicDefinition.getGraphicDefinition(this.graphicId);
                        var17 = var21.method966(this.anInt2826, this.anInt2805, this.anInt2761);
                        if (var17 != null) {
                            var17.method1897(0, -this.gfxPosY, 0);

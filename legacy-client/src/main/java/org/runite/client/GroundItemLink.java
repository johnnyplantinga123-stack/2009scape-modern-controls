        ...
        try {
            if (null != Unsorted.aClass3_Sub28_Sub3_2600) {
                ...
                if (anInt2737 == 10) {
                    ...
                    int var1 = -TextureOperation37.anInt3256 + (Class102.player.xAxis >> 7) + Class131.lowestVisibleTileX;
                    var1 += -5 + (int) (Math.random() * 10.0D);
                    int var2 = -Texture.lowestVisibleTileZ + -(Class102.player.yAxis >> 7) + Unsorted.anInt65 + -1 + Class108.anInt1460;

...
public final class Player extends Entity {
    ...
    final int getSize() {
        try {
            if (null == this.identityKit || this.identityKit.pnpcId == -1) {

                return super.getSize();
            } else {
                return NPCDefinition.getNPCDefinition(this.identityKit.pnpcId).size;
            }
    ...
    final void parseAppearance(int var1, DataBuffer buffer) {
        try {
            ...
            this.displayName = Objects.requireNonNull(Unsorted.decodeBase37(var20)).longToRSString();
            ...
            if (null == this.identityKit) {
                this.identityKit = new Class52();
            }

            var14 = this.identityKit.pnpcId;
            this.identityKit.method1161(colors, npcId, var4 == 1, look, this.renderAnimationId);
            if (npcId != var14) {
    ...
    final void animate(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
        try {
            if (this.identityKit != null) {
                SequenceDefinition var13 = this.animationId != -1 && 0 == this.anInt2828 ? SequenceDefinition.getAnimationDefinition(this.animationId) : null;
                ...
                Model var15 = this.identityKit.method1165(this.aClass145Array2809, this.anInt2776, var14, var13, this.anInt2802, this.anInt2793, -120, this.anInt2760, this.anInt2832, this.anInt2813);
                ...
                if (var15 != null) {
                    ...
                    Model var23;
                    if (Class140_Sub6.aBoolean2910 && (-1 == this.identityKit.pnpcId || NPCDefinition.getNPCDefinition(this.identityKit.pnpcId).aBoolean1249)) {
                    ...
                    if (Class102.player == this) {
                        for (var17 = ClientErrorException.hintMapMarkers.length + -1; var17 >= 0; --var17) {
                            Class96 var27 = ClientErrorException.hintMapMarkers[var17];
                            if (var27 != null && var27.playerModelId != -1) {
                                int var21;
                                int var20;
                                if (var27.type == 1 && 0 <= var27.actorTargetId && var27.actorTargetId < NPC.npcs.length) {
                                    NPC var24 = NPC.npcs[var27.actorTargetId];
                                    if (null != var24) {
                                        var20 = var24.xAxis / 32 - Class102.player.xAxis / 32;
                                        var21 = -(Class102.player.yAxis / 32) + var24.yAxis / 32;
                                        this.method1979(null, var21, var15, var20, var6, var11, var1, var8, var5, var4, var2, var27.playerModelId, var3, var7);
                                    }
                                }

                                if (var27.type == 2) {
                                    int var29 = 4 * (-Class131.lowestVisibleTileX + var27.targetX) + 2 + -(Class102.player.xAxis / 32);
                                    var20 = 2 + (4 * (var27.anInt1347 - Texture.lowestVisibleTileZ) - Class102.player.yAxis / 32);
                                    this.method1979(null, var20, var15, var29, var6, var11, var1, var8, var5, var4, var2, var27.playerModelId, var3, var7);
                                }

                                if (var27.type == 10 && var27.actorTargetId >= 0 && var27.actorTargetId < Unsorted.players.length) {
                                    Player var28 = Unsorted.players[var27.actorTargetId];
                                    if (null != var28) {
                    ...
                    var23 = null;
                    if (!this.aBoolean3968 && this.graphicId != -1 && this.anInt2805 != -1) {
                        GraphicDefinition var26 = GraphicDefinition.getGraphicDefinition(this.graphicId);
                        var23 = var26.method966(this.anInt2826, this.anInt2805, this.anInt2761);
                        if (var23 != null) {
                            var23.method1897(0, -this.gfxPosY, 0);

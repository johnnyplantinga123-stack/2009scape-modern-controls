   ...
   static void method2238(int var0, int var1, int var2, int var3, int var5) {
      try {
         ...
         if(Class163_Sub2_Sub1.anInt4014 >= 100) {
            ...
            Class139.cameraPitch = 2047 & (int)(Math.atan2(var10, var12) * 325.949D);
            TextureOperation28.cameraYaw = 2047 & (int)(Math.atan2(var9, var11) * -325.949D);
            if(128 > Class139.cameraPitch) {
               Class139.cameraPitch = 128;
            }

            if(383 < Class139.cameraPitch) {
               Class139.cameraPitch = 383;
            }
         }

         Class133.cameraMode = 2;

...
final class TextureOperation1 extends TextureOperation {
   ...
   static void method219(boolean var0) {
      try {
         if(var0) {
            ...
            for(Class3_Sub31 var2 = TextureOperation23.openInterfaces.first(); null != var2; var2 = TextureOperation23.openInterfaces.next()) {
               TextureOperation19.closeWidget(true, var2);
            }
            ...
            ConfigInventoryDefinition.parentWidgetId = Client.loginScreenInterfaceID;
   ...
   static void method221(int var0, RSString var1, RSString var2, RSString var3, int var4) {
      try {
         MessageManager.addChat(var0, var4, var1, var3, var2);

            ...
            if (0 != loginStage && 5 != loginStage) {
                try {
                    ...
                    if (loginStage == 2) {
                        ...
                        long var1 = PacketParser.localName37 = Class131.username.toLong();
                    ...
                    if (loginStage == 8) {
                        ...
                        Unsorted.packetOpcode = BufferedDataStream.incomingBuffer.getOpcode();
                        dynamic = Unsorted.packetOpcode == 214;
                        Unsorted.packetSize = BufferedDataStream.incomingBuffer.readUnsignedShort();
                        loginStage = 9;
                    }

                    if (loginStage == 9) {
                        if (Unsorted.packetSize > Class3_Sub15.activeConnection.availableBytes()) {
                            return;
                        }
                        ...
                        Class39.parseMapRegion(dynamic);

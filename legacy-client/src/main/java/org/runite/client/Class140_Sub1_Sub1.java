...
final class Class140_Sub1_Sub1 extends Model {
                        ...
                        if (var22 / var18 < Class145.screenUpperX) {
                            ...
                            if (var24 / var18 > Class1.screenUpperY) {
                                ...
                                if (var25 / var18 < AtmosphereParser.screenLowerY) {
                                    ...
                                    if (var9 > 0L && TextureOperation36.aBoolean3094 && var19 > 0) {
                                        int var28;
                                        int var30;
                                        if (var20 > 0) {
                                            var28 = var22 / var18;
    ...
    private static int method1905(int var0, short var1, int var2, byte var3) {
        ...
        if (var1 != -1) {
            int var5 = Class51.anInterface2_838.method19(93, var1 & 65535);
            int var6;
            int var8;
            if (var5 != 0) {
                if (var2 < 0) {
                ...
                if (var5 == 256) {
                    ...
                    var8 = 256 - var5;
                    var4 = ((var6 & 16711935) * var5 + (var4 & 16711935) * var8 & -16711936) + ((var6 & 65280) * var5 + (var4 & 65280) * var8 & 16711680) >> 8;
                }
            }

            var6 = Class51.anInterface2_838.method10(90, var1 & 65535);
            if (var6 != 0) {
                var6 += 256;
                ...
                var8 = ((var4 & 65280) >> 8) * var6;
                if (var8 > 65535) {
                    var8 = 65535;
                }

                int var9 = (var4 & 0xFF) * var6;
                if (var9 > 65535) {
                    var9 = 65535;
                }

                var4 = (var7 << 8 & 16711680) + (var8 & 65280) + (var9 >> 8);
            }
        }

        return (var4 << 8) + (255 - (var3 & 0xFF));
    }
                            ...
                            if (var11 < this.anIntArrayArray3829.length) {
                                ...
                                for (var13 = 0; var13 < var12.length; ++var13) {
                                    ...
                                    if (this.aShortArray3813 == null || (var7 & this.aShortArray3813[var14]) != 0) {
                                        var15 = (this.aByteArray3816[var14] & 0xFF) + var3 * 8;
                                        if (var15 < 0) {
                                            var15 = 0;
                                        } else if (var15 > 255) {
                                            var15 = 255;
                        ...
                        for (var10 = 0; var10 < var9; ++var10) {
                            ...
                            if (var11 < this.anIntArrayArray3829.length) {
                                ...
                                for (var13 = 0; var13 < var12.length; ++var13) {
                                    var14 = var12[var13];
                                    if (this.aShortArray3813 == null || (var7 & this.aShortArray3813[var14]) != 0) {
                                        var15 = this.aShortArray3808[var14] & 65535;
                                        var16 = var15 >> 10 & 63;
                                        var17 = var15 >> 7 & 7;
                                        var18 = var15 & 127;
                                        var16 = var16 + var3 & 63;
    ...
    final void method1908() {
        ...
        if (this.anIntArray3844 != null) {
            ...
            for (var3 = 0; var3 < this.anInt3823; ++var3) {
                var4 = this.anIntArray3844[var3] & 0xFF;
                ++var1[var4];
                if (var4 > var2) {
                    var2 = var4;
                }
        ...
        if (this.aByteArray3820 != null) {
            ...
            for (var3 = 0; var3 < this.anInt3852; ++var3) {
                var4 = this.aByteArray3820[var3] & 0xFF;
                ++var1[var4];
                if (var4 > var2) {
                    var2 = var4;
                }
    ...
    final void method1916(short var1, short var2) {
        ...
        int var4 = 0;
        if (var1 != -1) {
            var3 = Class51.anInterface2_838.method19(-125, var1 & 65535);
            var4 = Class51.anInterface2_838.method10(-98, var1 & 65535);
        }

        int var5 = 0;
        int var6 = 0;
        if (var2 != -1) {
            var5 = Class51.anInterface2_838.method19(57, var2 & 65535);
            var6 = Class51.anInterface2_838.method10(-114, var2 & 65535);
        }
                    ...
                    if (this.anIntArrayArray3829 != null && this.aByteArray3816 != null) {
                        for (var8 = 0; var8 < var7; ++var8) {
                            ...
                            if (var9 < this.anIntArrayArray3829.length) {
                                ...
                                for (var11 = 0; var11 < var10.length; ++var11) {
                                    var12 = var10[var11];
                                    var13 = (this.aByteArray3816[var12] & 0xFF) + var3 * 8;
                                    if (var13 < 0) {
                                        var13 = 0;
                                    } else if (var13 > 255) {
                                        var13 = 255;
                    ...
                    if (this.anIntArrayArray3829 != null) {
                        for (var8 = 0; var8 < var7; ++var8) {
                            ...
                            if (var9 < this.anIntArrayArray3829.length) {
                                ...
                                for (var11 = 0; var11 < var10.length; ++var11) {
                                    var12 = var10[var11];
                                    var13 = this.aShortArray3808[var12] & 65535;
                                    var14 = var13 >> 10 & 63;
                                    var15 = var13 >> 7 & 7;
                                    var16 = var13 & 127;
                                    var14 = var14 + var3 & 63;
        ...
        if (var1 == 0) {
            ...
            if (var1 == 2) {
                ...
                for (var5 = 0; var5 < this.anInt3852; ++var5) {
                    var6 = (this.aByteArray3816[var5] & 0xFF) + var2 * 8;
                    if (var6 < 0) {
                        var6 = 0;
                    } else if (var6 > 255) {
                        var6 = 255;
                ...
                for (var5 = 0; var5 < this.anInt3852; ++var5) {
                    var6 = this.aShortArray3808[var5] & 65535;
                    var7 = var6 >> 10 & 63;
                    var8 = var6 >> 7 & 7;
                    int var9 = var6 & 127;
                    var7 = var7 + var2 & 63;
    ...
    private void method1930() {
        ...
        if (this.anInt3852 != 0) {
            ...
            if (this.aClass121_3839.aClass156_1643 != null) {
                ...
                var1.glVertexPointer(3, GL2.GL_FLOAT, this.aClass121_3839.anInt1648, this.aClass121_3839.anInt1639);
            }
            ...
            if (this.aClass121_3814.aClass156_1643 != null) {
                ...
                var1.glColorPointer(4, GL2.GL_UNSIGNED_BYTE, this.aClass121_3814.anInt1648, this.aClass121_3814.anInt1639);
            }
            ...
            if (Class106.aBoolean1441 && this.aClass121_3815.aClass156_1643 != null) {
                ...
                var1.glNormalPointer(GL2.GL_FLOAT, this.aClass121_3815.anInt1648, this.aClass121_3815.anInt1639);
            }
            ...
            if (this.aClass121_3817.aClass156_1643 != null) {
                ...
                var1.glTexCoordPointer(2, GL2.GL_FLOAT, this.aClass121_3817.anInt1648, this.aClass121_3817.anInt1639);
            }
            ...
            if (this.aClass121_3839.aClass156_1643 == null || this.aClass121_3814.aClass156_1643 == null || Class106.aBoolean1441 && this.aClass121_3815.aClass156_1643 == null || this.aClass121_3817.aClass156_1643 == null) {
                if (HDToolKit.supportVertexBufferObject) {
                    var1.glBindBuffer(0x8892, 0);
                }

                if (this.aClass121_3839.aClass156_1643 == null) {
                    this.aClass121_3839.aByteBuffer1644.position(this.aClass121_3839.anInt1639);
                    var1.glVertexPointer(3, GL2.GL_FLOAT, this.aClass121_3839.anInt1648, this.aClass121_3839.aByteBuffer1644);
                }

                if (this.aClass121_3814.aClass156_1643 == null) {
                    this.aClass121_3814.aByteBuffer1644.position(this.aClass121_3814.anInt1639);
                    var1.glColorPointer(4, GL2.GL_UNSIGNED_BYTE, this.aClass121_3814.anInt1648, this.aClass121_3814.aByteBuffer1644);
                }

                if (Class106.aBoolean1441 && this.aClass121_3815.aClass156_1643 == null) {
                    this.aClass121_3815.aByteBuffer1644.position(this.aClass121_3815.anInt1639);
                    var1.glNormalPointer(GL2.GL_FLOAT, this.aClass121_3815.anInt1648, this.aClass121_3815.aByteBuffer1644);
                }

                if (this.aClass121_3817.aClass156_1643 == null) {
                    this.aClass121_3817.aByteBuffer1644.position(this.aClass121_3817.anInt1639);
                    var1.glTexCoordPointer(2, GL2.GL_FLOAT, this.aClass121_3817.anInt1648, this.aClass121_3817.aByteBuffer1644);
                }
            }

            if (this.aClass121_3846.aClass156_1643 == null && HDToolKit.supportVertexBufferObject) {
                var1.glBindBuffer(GL2.GL_ELEMENT_ARRAY_BUFFER, 0);
            }
            ...
            for (int var4 = 0; var4 < var3; ++var4) {
                ...
                if (this.aClass121_3846.aClass156_1643 == null) {
                    ...
                    var1.glDrawElements(4, (var6 - var5) * 3, GL2.GL_UNSIGNED_INT, this.aClass121_3846.aByteBuffer1644);
                } else {
                    var1.glDrawElements(4, (var6 - var5) * 3, GL2.GL_UNSIGNED_INT, var5 * 12);
                }
            }
    ...
    Class140_Sub1_Sub1(Model_Sub1 var1, int var2, int var3, boolean var4) {
        ...
        for (int var6 = 0; var6 < var1.anInt2849; ++var6) {
            if ((var1.aByteArray2859 == null || var1.aByteArray2859[var6] != 2) && (var1.aShortArray2858 == null || var1.aShortArray2858[var6] == -1 || !Class51.anInterface2_838.method12(var1.aShortArray2858[var6] & 65535, -65))) {
        ...
        for (var7 = 0; var7 < this.anInt3852; ++var7) {
            ...
            if (var1.aShortArray2858 != null) {
                ...
                if (var13 != -1) {
                    var11 = Class51.anInterface2_838.method18(var13 & 65535, 255);
                    var12 = Class51.anInterface2_838.method9(var13 & 65535, false);
                }
            }

            boolean var14 = var1.aByteArray2843 != null && var1.aByteArray2843[var8] != 0 || var13 != -1 && !Class51.anInterface2_838.method7((byte) 88, var13 & 65535);
        ...
        if (var1.aByteArray2866 != null) {
            ...
            for (var20 = 0; var20 < this.anInt3852; ++var20) {
                ...
                if (var1.aByteArray2866[var21] != -1) {
                    int var22 = var1.aByteArray2866[var21] & 0xFF;
            ...
            for (var20 = 0; var20 < var68; ++var20) {
                ...
                if (var76 > 0) {
                    ...
                    if (var76 == 1) {
                        ...
                        var82 = 64.0F / (float) (var1.aShortArray2882[var20] & 65535);
                    } else if (var76 == 2) {
                        var75 = 64.0F / (float) (var1.aShortArray2888[var20] & 65535);
                        var82 = 64.0F / (float) (var1.aShortArray2882[var20] & 65535);
                        var79 = 64.0F / (float) (var1.aShortArray2851[var20] & 65535);
                    } else {
                    ...
                    var65[var20] = method1906(var1.aShortArray2884[var20], var1.aShortArray2846[var20], var1.aShortArray2891[var20], var1.aByteArray2845[var20] & 0xFF, var75, var82, var79);
                }
            }
        }
        ...
        for (var68 = 0; var68 < this.anInt3852; ++var68) {
            ...
            var67 = var1.aShortArray2870[var70] & 65535;
            if (var1.aShortArray2858 == null) {
                var71 = -1;
            } else {
            ...
            if (var1.aByteArray2843 == null) {
                ...
                var74 = var1.aByteArray2843[var70] & 0xFF;
            }
            ...
            if (var71 != -1) {
                if (var72 == -1) {
                    ...
                    if (var28 == 0) {
                        ...
                        if (var28 == 1) {
                            var38 = (float) (var1.aShortArray2851[var72] & 65535) / 1024.0F;
                            ...
                            var49 = 64.0F / (float) (var1.aShortArray2888[var72] & 65535);
                            var50 = 64.0F / (float) (var1.aShortArray2882[var72] & 65535);
                            var51 = 64.0F / (float) (var1.aShortArray2851[var72] & 65535);

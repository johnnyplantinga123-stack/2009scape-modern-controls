            ...
            if(Unsorted.menuOptionCount < 400) {
               ...
               if(Class164_Sub1.anInt3012 == 1) {
                  ...
                  for(var12 = 7; var12 >= 0; --var12) {
                     if(null != Class91.playerOptions[var12]) {
                        short var14 = 0;
                        if(Class158.paramGameTypeID == 0 && Class91.playerOptions[var12].equalsStringIgnoreCase(TextCore.HasAttack)) {
                        ...
                        } else if(Class1.secondaryOption[var12]) {
                           var14 = 2000;
                        }

                        short var15 = Class7.aShortArray2167[var12];
                        var15 += var14;
                        Class3_Sub24_Sub4.pushRightClickMenuAction(TextureOperation35.playerOptCursor[var12], var0, (byte)-73, RSString.stringCombiner(new RSString[]{ColorCore.ContextColor , var5}), var4, var15, Class91.playerOptions[var12], var2);
                     }
                  }

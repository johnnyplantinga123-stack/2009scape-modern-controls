...
final class Class125 implements ShaderInterface {
    ...
    public final void method22() {
        if (this.anInt2186 >= 0) {
            ...
            if (!Class88.Texture3DEnabled) {
                var1.glBindTexture(GL2.GL_TEXTURE_2D, Class88.anIntArray1224[(int) ((float) (HDToolKit.anInt1791 * 64) * 0.0050F) % 64]);
            }
            ...
            if (this.anInt2182 != HDToolKit.anInt1791) {
                ...
                for (int var3 = 0; var3 < 64; ++var3) {
                    ...
                    var1.glProgramLocalParameter4fvARB(GL2.GL_VERTEX_PROGRAM_ARB, var3, this.aFloatBuffer2183);
                    var2 += 4;
                }

                if (Class88.Texture3DEnabled) {
                    var1.glProgramLocalParameter4fARB(GL2.GL_VERTEX_PROGRAM_ARB, 65, (float) HDToolKit.anInt1791 * 0.0050F, 0.0F, 0.0F, 1.0F);
                } else {
                    var1.glProgramLocalParameter4fARB(GL2.GL_VERTEX_PROGRAM_ARB, 65, 0.0F, 0.0F, 0.0F, 1.0F);
                }
    ...
    private void method1749() {
        ...
        var1.glNewList(this.anInt2186, GL2.GL_COMPILE);
        var1.glActiveTexture(GL2.GL_TEXTURE1);
        if (Class88.Texture3DEnabled) {
        ...
        var1.glActiveTexture(GL2.GL_TEXTURE0);
        var1.glBindProgramARB(GL2.GL_VERTEX_PROGRAM_ARB, this.anInt2184);
        var1.glEnable(GL2.GL_VERTEX_PROGRAM_ARB);
        var1.glEndList();
        var1.glNewList(this.anInt2186 + 1, GL2.GL_COMPILE);
        var1.glActiveTexture(GL2.GL_TEXTURE1);
        var1.glMatrixMode(GL2.GL_TEXTURE);
        var1.glLoadIdentity();
        var1.glMatrixMode(GL2.GL_MODELVIEW);
        ...
        var1.glDisable(Class88.Texture3DEnabled ? GL2.GL_TEXTURE_3D : GL2.GL_TEXTURE_2D);
        var1.glActiveTexture(GL2.GL_TEXTURE0);
        var1.glBindProgramARB(GL2.GL_VERTEX_PROGRAM_ARB, 0);
        var1.glDisable(GL2.GL_VERTEX_PROGRAM_ARB);
        var1.glDisable(GL2.GL_FRAGMENT_PROGRAM_ARB);
        var1.glEndList();
    }
    ...
    public final void method23(int var1) {
        if (this.anInt2186 >= 0) {
            ...
            if ((var1 & 128) == 0) {
                var2.glEnable(Class88.Texture3DEnabled ? GL2.GL_TEXTURE_3D : GL2.GL_TEXTURE_2D);
            } else {
                var2.glDisable(Class88.Texture3DEnabled ? GL2.GL_TEXTURE_3D : GL2.GL_TEXTURE_2D);
            }

            var2.glActiveTexture(GL2.GL_TEXTURE0);
            if ((var1 & 64) == 0) {
                var2.glGetFloatv(GL2.GL_LIGHT_MODEL_AMBIENT, aFloatArray2185, 0);
                var2.glProgramLocalParameter4fvARB(GL2.GL_VERTEX_PROGRAM_ARB, 66, aFloatArray2185, 0);
            } else {
                var2.glProgramLocalParameter4fARB(GL2.GL_VERTEX_PROGRAM_ARB, 66, 1.0F, 1.0F, 1.0F, 1.0F);
            }

            int var3 = var1 & 3;
            if (var3 == 2) {
                var2.glProgramLocalParameter4fARB(GL2.GL_VERTEX_PROGRAM_ARB, 64, 0.05F, 1.0F, 1.0F, 1.0F);
            } else if (var3 == 3) {
                var2.glProgramLocalParameter4fARB(GL2.GL_VERTEX_PROGRAM_ARB, 64, 0.1F, 1.0F, 1.0F, 1.0F);
            } else {
                var2.glProgramLocalParameter4fARB(GL2.GL_VERTEX_PROGRAM_ARB, 64, 0.025F, 1.0F, 1.0F, 1.0F);
            }

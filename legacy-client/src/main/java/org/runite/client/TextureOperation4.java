...
final class TextureOperation4 extends TextureOperation {
   ...
   static void updateVisibility(int var1, int var2) {
      try {
   ...
   static void method264(byte var0) {
      try {
         ...
         for(Class3_Sub31 var1 = TextureOperation23.openInterfaces.first(); null != var1; var1 = TextureOperation23.openInterfaces.next()) {
            if(var1.anInt2603 == 0) {
               TextureOperation19.closeWidget(true, var1);
            }
         }

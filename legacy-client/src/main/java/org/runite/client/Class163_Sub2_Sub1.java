...
final class Class163_Sub2_Sub1 extends Class163_Sub2 {
   ...
   static long[] recentMessages = new long[100];
   ...
   static void method2221(int var0, int var1, int var2, int var4, int var5, int var6) {
      try {
         ...
         for(Class96[] var7 = ClientErrorException.hintMapMarkers; var8 < var7.length; ++var8) {
            Class96 var9 = var7[var8];
            if(null != var9 && var9.type == 2) {
               Unsorted.method1724(var0 >> 1, var5, (-Texture.lowestVisibleTileZ + var9.anInt1347 << 7) - -var9.anInt1350, var9.anInt1353 * 2, var2 >> 1, var9.anInt1346 + (var9.targetX + -Class131.lowestVisibleTileX << 7), (byte)-114, var4);
               if(-1 < Class32.anInt590 && Class44.anInt719 % 20 < 10) {
                  Class166.hint_headicons[var9.anInt1351].drawAt(-12 + var1 + Class32.anInt590, -28 + var6 - -Texture.anInt2208);
               }
            }
         }

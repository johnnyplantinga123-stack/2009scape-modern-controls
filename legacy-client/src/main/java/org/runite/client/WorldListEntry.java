        ...
        try {
            if (0 > var0) {
                ...
                if (var2 == null) {
                    ...
                    for (int var4 = 0; var4 < var2.itemIds.length; ++var4) {
                        if (var2.itemIds[var4] == -1) {
                            ++var3;
                        }
                    }

                    var3 += Objects.requireNonNull(ConfigInventoryDefinition.retrieveConfigurationInventoryFile(var0)).size + -var2.itemIds.length;
                    return var3;
                }
            }

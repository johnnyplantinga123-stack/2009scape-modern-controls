...
public final class NPCRendering {
    ...
    static void updateNpcs(int var0) {
       try {
          ...
          if(Unsorted.packetSize == BufferedDataStream.incomingBuffer.index) {
 ...
 //            throw new RuntimeException("gnp1 pos:" + Class28.incomingBuffer.index + " psize:" + Class130.incomingPacketLength);
   ...
   static void addLocalNPCs() {
       try {
           while (true) {
               if (BufferedDataStream.incomingBuffer.method815(Unsorted.packetSize) >= 27) {
       ...
       try {
           ...
           for (i = 0; Unsorted.maskUpdateCount > i; ++i) {
               ...
               if ((var4 & 16) != 0) {
                   ...
                   Unsorted.animateNpc(var6, var5, 39, npc);
               }
               ...
               if (0 != (var4 & 128)) {
                   ...
                   boolean var7 = true;
                   if (var5 != -1 && npc.graphicId != -1 && SequenceDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(var5).animationId).forcedPriority < SequenceDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(npc.graphicId).animationId).forcedPriority) {
                       var7 = false;
                   }

                   if (var7) {
                       npc.graphicId = var5;
                       npc.gfxDelay = (65535 & var6) + Class44.anInt719;
                       npc.anInt2761 = 0;
                       npc.anInt2805 = 0;
                       npc.gfxPosY = var6 >> 16;
                       npc.anInt2826 = 1;
                       ...
                       if (npc.graphicId != -1 && Class44.anInt719 == npc.gfxDelay) {
                           int var8 = GraphicDefinition.getGraphicDefinition(npc.graphicId).animationId;
                           if (var8 != -1) {

...
final class Class68 {
    ...
    static void method1275() {
        ...
        for (var1 = 0; var1 < 4; ++var1) {
            int var2 = 16388 + var1;
            var0.glLightfv(var2, GL2.GL_AMBIENT, new float[]{0.0F, 0.0F, 0.0F, 1.0F}, 0);
            var0.glLightf(var2, GL2.GL_LINEAR_ATTENUATION, 0.0F);
            var0.glLightf(var2, GL2.GL_CONSTANT_ATTENUATION, 0.0F);
        }
    ...
    static void method1277(TileData[][][] var2) {
        if (Class106.aBoolean1441) {
            ...
            var3.glBlendFunc(GL2.GL_DST_COLOR, 1);
            var3.glFogfv(GL2.GL_FOG_COLOR, new float[]{0.0F, 0.0F, 0.0F, 0.0F}, 0);
            var3.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC0_RGB, GL2.GL_CONSTANT);
            var3.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_OPERAND0_RGB, GL2.GL_SRC_ALPHA);
                    ...
                    while (var10 <= var9) {
                        ...
                        while (true) {
                            if (var14 <= var13) {
                                ...
                                var3.glTexEnvfv(GL2.GL_TEXTURE_ENV, GL2.GL_TEXTURE_ENV_COLOR, new float[]{0.0F, 0.0F, 0.0F, var5.aFloat707}, 0);
            ...
            var3.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC0_RGB, GL2.GL_TEXTURE);
            var3.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_OPERAND0_RGB, GL2.GL_SRC_COLOR);
            var3.glBlendFunc(GL2.GL_SRC_ALPHA, GL2.GL_ONE_MINUS_SRC_ALPHA);
            var3.glDepthMask(true);
            var3.glFogfv(GL2.GL_FOG_COLOR, Class92.fogColor, 0);
            var3.glEnableClientState(GL2.GL_TEXTURE_COORD_ARRAY);
    ...
    private static void method1278(int var0, Class43 var1, int var2, int var3, int var4) {
        ...
        var6.glLightf(var5, GL2.GL_QUADRATIC_ATTENUATION, var1.aFloat710);
        var6.glLightfv(var5, GL2.GL_DIFFUSE, var1.aFloatArray717, 0);
        ...
        var6.glLightfv(var5, GL2.GL_POSITION, aFloatArray1022, 0);
    }

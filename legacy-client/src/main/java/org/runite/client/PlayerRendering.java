...
public final class PlayerRendering {
    ...
    static void updatePlayers() {
        try {
            ...
            if (BufferedDataStream.incomingBuffer.index == Unsorted.packetSize) {
    ...
    static void addLocalPlayers() {
        try {
            while (true) {
                if (BufferedDataStream.incomingBuffer.method815(Unsorted.packetSize) >= 11) {
                    ...
                    if (index != 2047) {
                        ...
                        var3.updatePlayerPosition(var5 + Class102.player.xOffsets2767[0], var7 == 1, Class102.player.yOffsets2755[0] + var8);
                        continue;
                    }
                }
    ...
    static void parsePlayerMask(int var0, int var1, Player var3) {
        try {
            ...
            if (0 != (var0 & 128)) {
                ...
                if (null != var3.displayName && var3.identityKit != null) {
                    ...
                    if (chatIcon <= 1) {
                        if (!var8 && (Class3_Sub15.aBoolean2433 && !Class121.aBoolean1641 || TextureOperation31.aBoolean3166)) {
                            ...
                            for (int var12 = 0; var12 < Class3_Sub28_Sub5.ignoreCount; ++var12) {
                    ...
                    if (!var11 && 0 == PacketParser.inTutorialIsland) {
                        ...
                        if (var8) {
                            ...
                            message = var14.aQuickChatDefinition_151.toChat(playerRenderBuffer);
                        } else {
                            message = Font.load(Objects.requireNonNull(Class32.toChat(playerRenderBuffer).properlyCapitalize()));
                        }
                        ...
                        if (chatIcon >= 2) {
                            MessageManager.addChat(var13, var8 ? 17 : 1, message, null, RSString.stringCombiner(new RSString[]{RSString.parse("<img=" + (chatIcon - 1) + ">"), var3.getName()}));
                        } else if (chatIcon == 1) {
                            MessageManager.addChat(var13, var8 ? 17 : 1, message, null, RSString.stringCombiner(new RSString[]{RSString.parse("<img=0>"), var3.getName()}));
                        } else {
                            MessageManager.addChat(var13, var8 ? 17 : 2, message, null, var3.getName());
                        }
                    }
                }
            ...
            if ((var0 & 32) != 0) {
                ...
                if (var3.textSpoken.charAt(0) == 126) {
                    var3.textSpoken = var3.textSpoken.substring(1);
                    BufferedDataStream.addChat(var3.getName(), 2, var3.textSpoken, (byte) -79 ^ 78);
            ...
            if ((256 & var0) != 0) {
                ...
                boolean var21 = true;
                if (var4 != -1 && var3.graphicId != -1 && SequenceDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(var4).animationId).forcedPriority < SequenceDefinition.getAnimationDefinition(GraphicDefinition.getGraphicDefinition(var3.graphicId).animationId).forcedPriority) {
                    var21 = false;
                }

                if (var21) {
                    var3.gfxDelay = (chatIcon & 65535) + Class44.anInt719;
                    var3.anInt2761 = 0;
                    var3.anInt2805 = 0;
                    var3.graphicId = var4;
                    if (Class44.anInt719 < var3.gfxDelay) {
                        var3.anInt2805 = -1;
                    }

                    var3.gfxPosY = chatIcon >> 16;
                    var3.anInt2826 = 1;
                    if (var3.graphicId != -1 && Class44.anInt719 == var3.gfxDelay) {
                        var7 = GraphicDefinition.getGraphicDefinition(var3.graphicId).animationId;
                        if (var7 != -1) {
                            SequenceDefinition var24 = SequenceDefinition.getAnimationDefinition(var7);
                            if (var24.frames != null) {
                                Unsorted.method1470(var3.yAxis, var24, var3.xAxis, var3 == Class102.player, 0);
                            }
                        }
                    }
                }
    ...
    static void method628(int var1, int var2, Player var3) {
        try {
            ...
            if (var3.animationId == var2 && var2 != -1) {
                ...
                if (1 == var5) {
                    ...
                    var3.anInt2832 = 0;
                    var3.anInt2773 = 0;
                    Unsorted.method1470(var3.yAxis, var4, var3.xAxis, Class102.player == var3, var3.anInt2832);
                }

                if (var5 == 2) {
                    var3.anInt2773 = 0;
                }
            } else if (-1 == var2 || var3.animationId == -1 || SequenceDefinition.getAnimationDefinition(var2).forcedPriority >= SequenceDefinition.getAnimationDefinition(var3.animationId).forcedPriority) {
                var3.anInt2776 = 1;
                var3.anInt2832 = 0;
                var3.anInt2828 = var1;
                ...
                if (var3.animationId != -1) {
                    Unsorted.method1470(var3.yAxis, SequenceDefinition.getAnimationDefinition(var3.animationId), var3.xAxis, var3 == Class102.player, var3.anInt2832);
                }
            }
            ...
            if (opcode != 0) {
                ...
                if (type == 0) {
                    ...
                    if (type == 1) { //Walk
                        ...
                        Class102.player.updatePlayerPosition(var7, var5 == 1, var4);
                    }
                }
            }

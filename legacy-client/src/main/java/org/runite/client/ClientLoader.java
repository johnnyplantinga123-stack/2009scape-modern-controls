...
public class ClientLoader extends Applet {
	...
	public void launch() {
		try {
			...
			frame = new JFrame(GameConfig.SERVER_NAME);
			frame.setIconImage(ImageIO.read(getClass().getClassLoader().getResource("09logo.png")));
			...
			//frame.setIconImage(Toolkit.getDefaultToolkit().getImage("./res/favicon.png"));
			frame.getContentPane().add(this.jp, "Center");
			frame.pack();

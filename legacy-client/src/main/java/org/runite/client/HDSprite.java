...
public class HDSprite extends AbstractSprite {
    ...
    private void method644(int var1) {
        if (this.anInt4078 != var1) {
            ...
            if (var1 == 2) {
                var2.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MIN_FILTER, GL2.GL_LINEAR);
                var2.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MAG_FILTER, GL2.GL_LINEAR);
            } else {
                var2.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MIN_FILTER, GL2.GL_NEAREST);
                var2.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MAG_FILTER, GL2.GL_NEAREST);
            }
        }
    }
    ...
    final void drawMinimapIcons(int interfaceWidth, int interfaceHeight, HDSprite var3) {
        if (var3 != null) {
            ...
            this.method644(1);
            var4.glActiveTexture(GL2.GL_TEXTURE1);
            var4.glEnable(GL2.GL_TEXTURE_2D);
            var4.glBindTexture(GL2.GL_TEXTURE_2D, var3.anInt4077);
            var4.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_COMBINE_RGB, GL2.GL_REPLACE);
            var4.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC0_RGB, GL2.GL_PREVIOUS);
            ...
            var4.glBegin(GL2.GL_TRIANGLE_FAN);
            ...
            var4.glEnd();
            var4.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_COMBINE_RGB, GL2.GL_MODULATE);
            var4.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC0_RGB, GL2.GL_TEXTURE);
            var4.glDisable(GL2.GL_TEXTURE_2D);
            var4.glActiveTexture(GL2.GL_TEXTURE0);
        }
    }
    ...
    final void method646(int var1, int var2, int var3, int var4, int var5) {
        ...
        var6.glBegin(GL2.GL_TRIANGLE_FAN);
    ...
    public final void drawMinimapRegion(int x, int y, int width, int height, int playerRelativeX, int playerRelativeY, int regionRotation, int zoom, HDSprite var9) {
        if (var9 != null) {
            ...
            if (GameConfig.MINIMAP_FILTER) {
                var9.method644(2); // apply linear filtering
            } else {
                var9.method644(1); // apply nearest-neighbor filtering
            }
            GL2 var10 = HDToolKit.gl;
            HDToolKit.bindTexture2D(this.anInt4077);
            if (GameConfig.MINIMAP_FILTER) {
                this.method644(2); // apply linear filtering
            } else {
                this.method644(1); // apply nearest-neighbor filtering
            }
            var10.glActiveTexture(GL2.GL_TEXTURE1);
            var10.glEnable(GL2.GL_TEXTURE_2D);
            var10.glBindTexture(GL2.GL_TEXTURE_2D, var9.anInt4077);
            var10.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_COMBINE_RGB, GL2.GL_REPLACE);
            var10.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC0_RGB, GL2.GL_PREVIOUS);
            int var11 = -width / 2;
            int var12 = -height / 2;
            int var13 = -var11;
            int var14 = -var12;
    ...
    final void method641(int var1, int var2) {
        ...
        var3.glBegin(GL2.GL_TRIANGLE_FAN);
    ...
    public final void method639(int var1, int var2, int var3, int var4) {
        if (var3 > 0 && var4 > 0) {
            ...
            var20.glBegin(GL2.GL_TRIANGLE_FAN);
    ...
    final void method642(int var1, int var2, int var3, int var4, int var5) {
        if (var3 > 0 && var4 > 0) {
            ...
            var22.glBegin(GL2.GL_TRIANGLE_FAN);
    ...
    final void method649(int var1, int var2, int var3, int var4) {
        ...
        var5.glBegin(GL2.GL_TRIANGLE_FAN);
    ...
    void method650(int[] var1) {
        ...
        HDToolKit.bindTexture2D(this.anInt4077);
        var10.glTexImage2D(GL2.GL_TEXTURE_2D, 0, GL2.GL_RGBA, this.anInt4075, this.anInt4079, 0, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, var9);
    ...
    private void method651() {
        ...
        var3.glNewList(this.anInt4076, GL2.GL_COMPILE);
        var3.glBegin(GL2.GL_TRIANGLE_FAN);

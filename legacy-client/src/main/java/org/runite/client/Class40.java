        ...
        try {
            ...
            if (var1) {
                ...
                for (var2 = 0; var2 < Class164_Sub2.aByteArrayArray3027.length; ++var2) {
                    ...
                    if (null != var3) {
                        var5 = -Texture.lowestVisibleTileZ + (Class3_Sub24_Sub3.regionIds[var2] & 0xFF) * 64;
                        var4 = -Class131.lowestVisibleTileX + (Class3_Sub24_Sub3.regionIds[var2] >> 8) * 64;
                    ...
                    if (HDToolKit.highDetail) {
                        ...
                        if (null != var3) {
                            var4 = -Class131.lowestVisibleTileX + 64 * (Class3_Sub24_Sub3.regionIds[var2] >> 8);
                            var5 = -Texture.lowestVisibleTileZ + 64 * (Class3_Sub24_Sub3.regionIds[var2] & 0xFF);
                            if (LinkableRSString.isDynamicSceneGraph) {
                                var5 = 10;
                                var4 = 10;
                            }
                ...
                if (var1) {
                    ...
                    for (var4 = 0; var4 < 104; ++var4) {
                        for (var5 = 0; 104 > var5; ++var5) {
                            Class128.updateGroundItems(var5, var4);
                        }
                    }
                                ...
                                if (var13 == 0) {
                                    ...
                                    if (var27 < 0) {
                                        if (var26.anInt2103 == -1) {
                                            ...
                                            var31 = (var28 & 896) + ((0xfc00 & var28 + var4) - -var55);
                                    ...
                                    if (var26.anInt2098 >= 0) {
                                        ...
                                        int var32 = (896 & var55) + ((0xfc00 & var55 + var4) - -var31);

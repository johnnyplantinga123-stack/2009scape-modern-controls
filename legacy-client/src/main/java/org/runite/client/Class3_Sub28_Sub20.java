            ...
            if((1 & var7) == 0) {
               if(this.anInt3795 == -1) {
                  ...
                  if(2 == this.anInt3788) {
                     ...
                     glu.gluBuild2DMipmaps(GL2.GL_TEXTURE_2D, GL2.GL_RGBA, var6, var6, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, var9);
                     ...
                     while (true) {
                        var5.glTexImage2D(GL2.GL_TEXTURE_2D, var10++, GL2.GL_RGBA, var6, var6, 0, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, var9);
                        var6 >>= 1;
                        if (0 == var6) {
                           var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MIN_FILTER, GL2.GL_LINEAR_MIPMAP_LINEAR);
                           var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MAG_FILTER, GL2.GL_LINEAR);
                     ...
                     var5.glTexImage2D(GL2.GL_TEXTURE_2D, 0, GL2.GL_RGBA, var6, var6, 0, GL2.GL_RGBA, GL2.GL_UNSIGNED_BYTE, var9);
                     var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MIN_FILTER, GL2.GL_LINEAR);
                     var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MAG_FILTER, GL2.GL_LINEAR);
                     Class31.anInt580 += var9.limit() - this.anInt3796;
                     this.anInt3796 = var9.limit();
                  }

                  var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_WRAP_S, !this.aBoolean3787 ? GL2.GL_CLAMP_TO_EDGE : GL2.GL_REPEAT);
                  var5.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_WRAP_T, this.aBoolean3781 ? GL2.GL_REPEAT : GL2.GL_CLAMP_TO_EDGE);
               } else {
                  HDToolKit.bindTexture2D(this.anInt3795);
               }
            }

...
public final class Class21 {
    ...
    static void method914(int interfaceId, int interfaceHash, int walkable) {
        try {
            ...
            var4.widgetId = interfaceId;
            TextureOperation23.openInterfaces.put(interfaceHash, var4);
            ...
            if (ConfigInventoryDefinition.parentWidgetId != -1) {
                Class3_Sub8.runScripts(6422 ^ 6509, 1, ConfigInventoryDefinition.parentWidgetId);
            }

...
//            return PacketParser.parseIncomingPackets();
         ...
         String var2 = "T2 - " + Unsorted.packetOpcode + "," + Class7.anInt2166 + "," + Class24.anInt469 + " - " + Unsorted.packetSize + "," + (Class131.lowestVisibleTileX - -Class102.player.xOffsets2767[0]) + "," + (Class102.player.yOffsets2755[0] + Texture.lowestVisibleTileZ) + " - ";

         for (int var3 = 0; var3 < Unsorted.packetSize && 50 > var3; ++var3) {

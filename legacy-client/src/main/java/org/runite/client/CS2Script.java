...
public final class CS2Script extends Linkable {
    ...
    static int contactServerState = 0;
    ...
    static void method379() {
        try {
            ...
            if (var8 > Class139.cameraPitch) {
                Class139.cameraPitch += Class75.anInt1105 + Class163_Sub2_Sub1.anInt4014 * (-Class139.cameraPitch + var8) / 1000;
                if (Class139.cameraPitch > var8) {
                    Class139.cameraPitch = var8;
                }
            }

            if (Class139.cameraPitch > var8) {
                Class139.cameraPitch -= (Class139.cameraPitch - var8) * Class163_Sub2_Sub1.anInt4014 / 1000 + Class75.anInt1105;
                if (var8 > Class139.cameraPitch) {
                    Class139.cameraPitch = var8;
                }
            }

            int var10 = -TextureOperation28.cameraYaw + var9;
            if (var10 > 1024) {
                var10 -= 2048;
            }
            ...
            if (var10 > 0) {
                TextureOperation28.cameraYaw += var10 * Class163_Sub2_Sub1.anInt4014 / 1000 + Class75.anInt1105;
                TextureOperation28.cameraYaw &= 2047;
            }

            if (var10 < 0) {
                TextureOperation28.cameraYaw -= Class163_Sub2_Sub1.anInt4014 * -var10 / 1000 + Class75.anInt1105;
                TextureOperation28.cameraYaw &= 2047;
            }

            int var11 = -TextureOperation28.cameraYaw + var9;
            if (1024 < var11) {
                var11 -= 2048;
            }
            ...
            if (var11 < 0 && var10 > 0 || var11 > 0 && var10 < 0) {
                TextureOperation28.cameraYaw = var9;
            }
    ...
    static void runAssembledScript(int maxIterations, CS2Script script) {
        try {
            ...
            int scriptId = (Integer) aobj[0];
            AssembledMethod currentMethod = ItemDefinition.getCS2ById(scriptId);
            ...
            int stringArgIter = 0;
            int intArgIter = 0;
            for (int argIndex = 1; aobj.length > argIndex; argIndex++) {
                if (aobj[argIndex] instanceof Integer) {
                    int arg = (Integer) aobj[argIndex];
                    boolean printK2 = false;
                    if (arg == 0x80000001)
                        arg = script.worldSelectCursorPositionX; // Why does this matter?
                    if (arg == 0x80000002)
                        arg = script.scrollbarScrollAmount;
                    if (arg == 0x80000003)
                        arg = null == script.aClass11_2449 ? -1 : script.aClass11_2449.componentHash;
                    if (arg == 0x80000004)
                        arg = script.interfaceButtons;
                    if (arg == 0x80000005)
                        arg = null == script.aClass11_2449 ? -1 : script.aClass11_2449.anInt191;
                    if (arg == 0x80000006)
                        arg = null == script.aClass11_2438 ? -1 : script.aClass11_2438.componentHash;
                    if (arg == 0x80000007)
                        arg = script.aClass11_2438 != null ? script.aClass11_2438.anInt191 : -1;
                    if (arg == 0x80000008)
                        arg = script.inputTextCode;
                    if (arg == 0x80000009)
                        arg = script.anInt2443;
                    ItemDefinition.intArguments[intArgIter++] = arg;
                    continue;
                }
                if (!(aobj[argIndex] instanceof RSString))
                    continue;
                RSString class94 = (RSString) aobj[argIndex];
            ...
            do {
                ...
                if (opcode < 100) {
                    ...
                    if (opcode == CS2AsmOpcodes.PUSH_INT_FROM_RAM.getOp()) {
                        ...
                        ItemDefinition.intsStack[iStackCounter++] = ItemDefinition.varp[l2];
                        continue;
                    }
                    ...
                    if (opcode == CS2AsmOpcodes.CALL.getOp()) {
                        ...
                        AssembledMethod assembledMethod_1 = ItemDefinition.getCS2ById(op);
                ...
                if (500 <= opcode) {
                    ...
                    if ((opcode < 1100 || 1200 <= opcode) && (opcode < 2100 || 2200 <= opcode)) {
                        if ((opcode < 1200 || 1300 <= opcode) && (2200 > opcode || opcode >= 2300)) {
                            ...
                            if ((opcode < 1400 || opcode >= 1500) && (2400 > opcode || opcode >= 2500)) {
                                ...
                                if (opcode < 1700) {
                                    ...
                                    if (opcode == 1605) {
                                        ItemDefinition.intsStack[iStackCounter++] = class11_5.scale;
                                        continue;
                                    }
                                    if (opcode == 1606) {
                                        ItemDefinition.intsStack[iStackCounter++] = class11_5.pitch;
                                        continue;
                                    }
                                    if (1607 == opcode) {
                                    ...
                                    if (opcode == 1608) {
                                        ItemDefinition.intsStack[iStackCounter++] = class11_5.yawId;
                                        continue;
                                    }
                                    if (opcode == 1609) {
                                ...
                                if (opcode >= 1800) {
                                    ...
                                    if (opcode >= 2700) {
                                            ...
                                            if (opcode >= 2900) {
                                                if (opcode < 3200) {
                                                    if (opcode == 3100) {
                                                        ...
                                                        BufferedDataStream.addChat(TextCore.aString_2331, 0, class94_3, -1);
                                                        continue;
                                                    }
                                                    if (opcode == 3101) {
                                                        iStackCounter -= 2;
                                                ...
                                                if (opcode < 3300) {
                                                    if (opcode == 3200) {
                                                        iStackCounter -= 3;
                                                        AudioHandler.playSfx(ItemDefinition.intsStack[iStackCounter + 1], ItemDefinition.intsStack[iStackCounter], ItemDefinition.intsStack[iStackCounter + 2]);
                                                        continue;
                                                    }
                                                    if (opcode == 3201) {
                                                        AudioHandler.playMusic(ItemDefinition.intsStack[--iStackCounter]);
                                                        continue;
                                                    }
                                                    if (opcode != 3202)
                                                        break;
                                                    iStackCounter -= 2;
                                                    AudioHandler.playJingle(ItemDefinition.intsStack[iStackCounter]);
                                                    continue;
                                                }
                                                if (opcode < 3400) {
                                                    if (opcode == 3300) {
                                                    ...
                                                    if (opcode == 3305) { //Skill update listener (mostly spams health value)
                                                        ...
                                                        ItemDefinition.intsStack[iStackCounter++] = TextureOperation17.level[i9];
                                                        continue;
                                                    }
                                                    if (opcode == 3306) { //Another Skill update listener (spams 10? Possible TOTAL hp)
                                                        int j9 = ItemDefinition.intsStack[--iStackCounter];
                                                        ItemDefinition.intsStack[iStackCounter++] = Class3_Sub20.maxLevel[j9];
                                                    ...
                                                    if (3307 == opcode) { //Hover tooltip for Skill Interface, total xp for selected skill
                                                        ...
                                                        ItemDefinition.intsStack[iStackCounter++] = Class133.experience[k9];
                                                        continue;
                                                    }
                                                    if (opcode == 3308) {
                                                        int l9 = WorldListCountry.localPlane;
                                                        int k47 = Class131.lowestVisibleTileX + (Class102.player.xAxis >> 7);
                                                        int i68 = (Class102.player.yAxis >> 7) - -Texture.lowestVisibleTileZ;
                                                    ...
                                                    if (opcode == 3317) {
                                                        ItemDefinition.intsStack[iStackCounter++] = Class38_Sub1.systemUpdateTime;
                                                        continue;
                                                    }
                                                    if (3318 == opcode) {
                                                    ...
                                                    if (3321 == opcode) {
                                                        ItemDefinition.intsStack[iStackCounter++] = Unsorted.runEnergy;
                                                        continue;
                                                    }
                                                    if (opcode == 3322) {
                                                        ItemDefinition.intsStack[iStackCounter++] = MouseListeningClass.runWeight;
                                                        continue;
                                                    }
                                                    if (3323 == opcode) {
                                                    ...
                                                    if (3327 == opcode) {
                                                        ItemDefinition.intsStack[iStackCounter++] = Class102.player.identityKit.aBoolean864 ? 1 : 0;
                                                        continue;
                                                    }
                                                    if (3328 == opcode) {
                                                ...
                                                if (3700 > opcode) {
                                                    if (3600 == opcode) {
                                                        if (contactServerState == 0)
                                                            ItemDefinition.intsStack[iStackCounter++] = -2;
                                                        else if (contactServerState != 1)
                                                            ItemDefinition.intsStack[iStackCounter++] = Class8.totalFriendCount;
                                                        else
                                                            ItemDefinition.intsStack[iStackCounter++] = -1;
                                                        continue;
                                                    }
                                                    if (3601 == opcode) {
                                                        ...
                                                        if (contactServerState != 2 || Class8.totalFriendCount <= l13)
                                                            ItemDefinition.stringsStack[sStackCounter++] = TextCore.aString_2331;
                                                        else
                                                            ItemDefinition.stringsStack[sStackCounter++] = Class70.friendNameString[l13];
                                                        continue;
                                                    }
                                                    if (opcode == 3602) {
                                                        int i14 = ItemDefinition.intsStack[--iStackCounter];
                                                        if (contactServerState != 2 || i14 >= Class8.totalFriendCount)
                                                            ItemDefinition.intsStack[iStackCounter++] = 0;
                                                        else
                                                            ItemDefinition.intsStack[iStackCounter++] = Unsorted.friendWorldId[i14];
                                                        continue;
                                                    }
                                                    if (opcode == 3603) {
                                                        int j14 = ItemDefinition.intsStack[--iStackCounter];
                                                        if (2 == contactServerState && Class8.totalFriendCount > j14)
                                                    ...
                                                    if (opcode == 3610) {
                                                        ...
                                                        if (contactServerState == 2 && Class8.totalFriendCount > k14)
                                                            ItemDefinition.stringsStack[sStackCounter++] = Unsorted.friendWorldName[k14];
                                                        else
                                                            ItemDefinition.stringsStack[sStackCounter++] = TextCore.aString_2331;
                                                        continue;
                                                    }
                                                    if (opcode == 3611) {
                                                        if (RSInterface.chatroomName != null)
                                                            ItemDefinition.stringsStack[sStackCounter++] = RSInterface.chatroomName.longToRSString();
                                                        else
                                                            ItemDefinition.stringsStack[sStackCounter++] = TextCore.aString_2331;
                                                        continue;
                                                    }
                                                    if (opcode == 3612) {
                                                        if (null != RSInterface.chatroomName)
                                                            ItemDefinition.intsStack[iStackCounter++] = Unsorted.clanMemberCount;
                                                        else
                                                            ItemDefinition.intsStack[iStackCounter++] = 0;
                                                        continue;
                                                    }
                                                    if (opcode == 3613) {
                                                        ...
                                                        if (RSInterface.chatroomName == null || l14 >= Unsorted.clanMemberCount)
                                                            ItemDefinition.stringsStack[sStackCounter++] = TextCore.aString_2331;
                                                        else
                                                            ItemDefinition.stringsStack[sStackCounter++] = PacketParser.clanChatMembers[l14].username.longToRSString();
                                                        continue;
                                                    }
                                                    if (opcode == 3614) {
                                                        int i15 = ItemDefinition.intsStack[--iStackCounter];
                                                        if (RSInterface.chatroomName == null || i15 >= Unsorted.clanMemberCount)
                                                            ItemDefinition.intsStack[iStackCounter++] = 0;
                                                        else
                                                            ItemDefinition.intsStack[iStackCounter++] = PacketParser.clanChatMembers[i15].worldId;
                                                        continue;
                                                    }
                                                    if (3615 == opcode) {
                                                        int j15 = ItemDefinition.intsStack[--iStackCounter];
                                                        if (null == RSInterface.chatroomName || j15 >= Unsorted.clanMemberCount)
                                                            ItemDefinition.intsStack[iStackCounter++] = 0;
                                                        else
                                                            ItemDefinition.intsStack[iStackCounter++] = PacketParser.clanChatMembers[j15].rights;
                                                        continue;
                                                    }
                                                    if (3616 == opcode) {
                                                    ...
                                                    if (opcode == 3618) {
                                                        ItemDefinition.intsStack[iStackCounter++] = Class91.userClanRights;
                                                        continue;
                                                    }
                                                    if (opcode == 3619) {
                                                    ...
                                                    if (opcode == 3621) {
                                                        if (contactServerState == 0)
                                                            ...
                                                            ItemDefinition.intsStack[iStackCounter++] = Class3_Sub28_Sub5.ignoreCount;
                                                        continue;
                                                    }
                                                    if (3622 == opcode) {
                                                        int k15 = ItemDefinition.intsStack[--iStackCounter];
                                                        if (contactServerState == 0 || Class3_Sub28_Sub5.ignoreCount <= k15)
                                                            ItemDefinition.stringsStack[sStackCounter++] = TextCore.aString_2331;
                                                        else
                                                            ItemDefinition.stringsStack[sStackCounter++] = Unsorted.decodeBase37(Class114.ignoreList[k15]).longToRSString();
                                                        continue;
                                                    }
                                                    if (3623 == opcode) {
                                                    ...
                                                    if (opcode == 3624) {
                                                        ...
                                                        if (null != PacketParser.clanChatMembers && l15 < Unsorted.clanMemberCount && PacketParser.clanChatMembers[l15].username.equalsStringIgnoreCase(Class102.player.displayName))
                                                            ItemDefinition.intsStack[iStackCounter++] = 1;
                                                        else
                                                            ItemDefinition.intsStack[iStackCounter++] = 0;
                                                        continue;
                                                    ...
                                                    if (opcode == 3625) {
                                                        if (Class161.chatOwnerName == null)
                                                            ItemDefinition.stringsStack[sStackCounter++] = TextCore.aString_2331;
                                                        else
                                                            ItemDefinition.stringsStack[sStackCounter++] = Class161.chatOwnerName.longToRSString();
                                                        continue;
                                                    }
                                                    if (3626 == opcode) {
                                                        int i16 = ItemDefinition.intsStack[--iStackCounter];
                                                        if (RSInterface.chatroomName == null || i16 >= Unsorted.clanMemberCount)
                                                            ItemDefinition.stringsStack[sStackCounter++] = TextCore.aString_2331;
                                                        else
                                                            ItemDefinition.stringsStack[sStackCounter++] = PacketParser.clanChatMembers[i16].worldName;
                                                        continue;
                                                    }
                                                    if (opcode == 3627) {
                                                        int j16 = ItemDefinition.intsStack[--iStackCounter];
                                                        if (contactServerState != 2 || 0 > j16 || Class8.totalFriendCount <= j16)
                                                            ItemDefinition.intsStack[iStackCounter++] = 0;
                                                        else
                                                            ...
                                                            if (opcode >= 4600) {
                                                                if (opcode < 5100) {
                                                                    ...
                                                                    if (opcode == 5055) {
                                                                        ...
                                                                        ItemDefinition.stringsStack[sStackCounter++] = QuickChat.load(k26).method554();
                                                                        continue;
                                                                    }
                                                                    if (opcode == 5056) {
                                                                        int l26 = ItemDefinition.intsStack[--iStackCounter];
                                                                        QuickChatDefinition quickChatDefinition = QuickChat.load(l26);
                                                                    ...
                                                                    if (opcode == 5057) {
                                                                        ...
                                                                        ItemDefinition.intsStack[iStackCounter++] = QuickChat.load(i27).anIntArray3567[k56];
                                                                        continue;
                                                                    }
                                                                    if (opcode == 5058) {
                                                                        CS2Methods.aQuickChat_1056 = new QuickChat();
                                                                        CS2Methods.aQuickChat_1056.anInt149 = ItemDefinition.intsStack[--iStackCounter];
                                                                        CS2Methods.aQuickChat_1056.aQuickChatDefinition_151 = QuickChat.load(CS2Methods.aQuickChat_1056.anInt149);
                                                                    ...
                                                                    if (opcode == 5066) {
                                                                        ...
                                                                        ItemDefinition.intsStack[iStackCounter++] = QuickChat.load(l28).method552();
                                                                        continue;
                                                                    }
                                                                    if (opcode == 5067) {
                                                                        iStackCounter -= 2;
                                                                        ...
                                                                        int i70 = QuickChat.load(i29).method550(49, i58);
                                                                    ...
                                                                    if (opcode == 5070) {
                                                                        ...
                                                                        QuickChatDefinition quickChatDefinition_1 = QuickChat.load(l29);
                                                                ...
                                                                if (5500 > opcode) {
                                                                    ...
                                                                    if (opcode == 5419) {
                                                                        ...
                                                                        if (null != Class136.lastlogAdress) {
                                                                            class94_24 = Class108.method1653(Class136.lastlogAdress.anInt979);
                                                                            if (Class136.lastlogAdress.anObject974 != null) {
                                                                                byte[] abyte0 = null;
                                                                                abyte0 = ((String) Class136.lastlogAdress.anObject974).getBytes(StandardCharsets.ISO_8859_1);
                                                                    ...
                                                                    if (opcode == 5421) {
                                                                        ...
                                                                        if (null == GameShell.frame && (!flag5 || Signlink.anInt1214 == 3 || !Signlink.osName.startsWith("win") || Class106.paramUserUsingInternetExplorer)) {
                                                                            Class99.openUrl(class94_64, (byte) 127, flag5);
                                                                        } else {
                                                                ...
                                                                if (5600 > opcode) {
                                                                    if (5500 == opcode) {
                                                                        ...
                                                                        Class3_Sub20.method390(false, j72, i60, l77, (byte) -128, -Texture.lowestVisibleTileZ + (0x3fff & l33), ((0xffffe30 & l33) >> 14) - Class131.lowestVisibleTileX);
                                                                        continue;
                                                                    }
                                                                    if (opcode == 5501) {
                                                                        iStackCounter -= 4;
                                                                        ...
                                                                        Class164_Sub1.method2238(j60, (0x3fff & i34) - Texture.lowestVisibleTileZ, k72, -Class131.lowestVisibleTileX + ((0xffff221 & i34) >> 14), i78);
                                                                        continue;
                                                                    }
                                                                    if (opcode == 5502) {
                                                                        iStackCounter -= 6;
                                                                    ...
                                                                    if (5504 == opcode) {
                                                                        iStackCounter -= 2;
                                                                        Unsorted.pitchTarget = ItemDefinition.intsStack[iStackCounter];
                                                                        GraphicDefinition.yawTarget = ItemDefinition.intsStack[iStackCounter + 1];
                                                                    ...
                                                                    if (opcode == 5505) {
                                                                        ItemDefinition.intsStack[iStackCounter++] = Unsorted.pitchTarget;
                                                                        continue;
                                                                    }
                                                                    if (5506 != opcode)
                                                                        break;
                                                                    ItemDefinition.intsStack[iStackCounter++] = GraphicDefinition.yawTarget;
                                                                    continue;
                                                                }
                                                                if (opcode >= 5700) {
                                                                    if (6100 > opcode) {
                                                ...
                                                if (4105 == opcode) {
                                                    ...
                                                    if (Class102.player.identityKit == null || !Class102.player.identityKit.aBoolean864)
                                                ...
                                                if (4111 == opcode) {
                                                    ...
                                                    ItemDefinition.stringsStack[sStackCounter++] = Font.load(class94_37);
                                                    continue;
                                                }
                                                if (4112 == opcode) {
                                        ...
                                        if (opcode == 2702) {
                                            ...
                                            Class3_Sub31 class3_sub31 = TextureOperation23.openInterfaces.get(l42);
                                        ...
                                        Class3_Sub31 class3_sub31_1 = TextureOperation23.openInterfaces.get(i43);
                                        if (class3_sub31_1 == null || class3_sub31_1.widgetId != j65)
                                            ItemDefinition.intsStack[iStackCounter++] = 0;
                                        else
                                            ItemDefinition.intsStack[iStackCounter++] = 1;
                                        continue;
                                    ...
                                    if (opcode == 2605) {
                                        ItemDefinition.intsStack[iStackCounter++] = class11_12.scale;
                                        continue;
                                    }
                                    if (opcode == 2606) {
                                        ItemDefinition.intsStack[iStackCounter++] = class11_12.pitch;
                                        continue;
                                    }
                                    if (opcode == 2607) {
                                    ...
                                    if (2608 == opcode) {
                                        ItemDefinition.intsStack[iStackCounter++] = class11_12.yawId;
                                        continue;
                                    }
                                    if (opcode == 2609) {
                                ...
                                if (class94_62.length() > 0 && class94_62.charAt(class94_62.length() + -1) == 89) {
                        ...
                        if (opcode == 1200 || 1205 == opcode) {
                            ...
                            if (-1 == k65) {
                                ...
                                class11_15.pitch = class48_4.iconPitch;
                                class11_15.anInt264 = class48_4.anInt754;
                                class11_15.yawId = class48_4.iconYAw;
                                class11_15.scale = class48_4.iconScale;
                                if (class11_15.anInt184 > 0)
                                    class11_15.scale = (class11_15.scale * 32) / class11_15.anInt184;
                                else if (class11_15.defWidth > 0)
                                    class11_15.scale = (class11_15.scale * 32) / class11_15.defWidth;
                        ...
                        if (opcode == 1201) {
                            ...
                            class11_15.mediaId = ItemDefinition.intsStack[--iStackCounter];
                        ...
                        if (opcode == 1202) {
                            ...
                            class11_15.mediaId = Class102.player.identityKit.method1163();
                            if (class11_15.anInt191 == -1)
                                Class162.method2206(class11_15.componentHash);
                            continue;
                        }
                    ...
                    if (opcode == 1108) {
                        ...
                        class11_16.mediaId = ItemDefinition.intsStack[--iStackCounter];
                        Class20.flagUpdate(class11_16);
                        if (class11_16.anInt191 == -1)
                    ...
                    if (opcode == 1109) {
                        ...
                        class11_16.pitch = ItemDefinition.intsStack[2 + iStackCounter];
                        class11_16.yawId = ItemDefinition.intsStack[iStackCounter - -3];
                        class11_16.anInt280 = ItemDefinition.intsStack[iStackCounter - -4];
                        class11_16.scale = ItemDefinition.intsStack[5 + iStackCounter];
                        Class20.flagUpdate(class11_16);
                        if (class11_16.anInt191 == -1) {
                    ...
                    if (opcode != 1123)
                        break;
                    class11_16.scale = ItemDefinition.intsStack[--iStackCounter];
                    Class20.flagUpdate(class11_16);
                    if (class11_16.anInt191 == -1)
                        TextureOperation4.method265(class11_16.componentHash);
                    continue;
                ...
                if (opcode == 403) {
                    ...
                    while (Class3_Sub26.anIntArray2559.length > k75) {
                        if (j43 == Class3_Sub26.anIntArray2559[k75]) {
                            Class102.player.identityKit.method1164(k75, i66);
                            continue label0;
                        }
                        k75++;
                    }
                ...
                if (404 == opcode) {
                    ...
                    Class102.player.identityKit.method1162(k43, j66);
                    continue;
                }
                if (opcode != 410)
                    break;
                try {
                    ...
                    Class102.player.identityKit.method1159(flag2);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            } while (true);
    ...
    static int method1643(boolean var1, int var2, int var3) {
        try {
            ...
            RSContainer var4 = (RSContainer) TileData.containerTable.get(var2);
            if (null == var4) {
                return 0;
            } else {
                int var5 = 0;

                for (int var6 = 0; var6 < var4.itemIds.length; ++var6) {
                    if (var4.itemIds[var6] >= 0 && TextureOperation39.itemDefinitionSize > var4.itemIds[var6]) {
                        ItemDefinition var7 = ItemDefinition.getItemDefinition(var4.itemIds[var6]);
                        if (null != var7.aHashTable_798) {
                            LinkableInt var8 = (LinkableInt) var7.aHashTable_798.get(var3);
                            if (null != var8) {
                                if (var1) {
                                    var5 += var4.amounts[var6] * var8.value;
                                } else {
                                    var5 += var8.value;
                                }
                            }

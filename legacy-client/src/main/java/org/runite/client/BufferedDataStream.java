...
public final class BufferedDataStream extends DataBuffer {
    ...
    static void addChat(RSString var0, int type, RSString message, int var3) {
        try {
            MessageManager.addChat(var3, type, message, null, var0);
        ...
        try {
            if (var1 >= 0) {
                ...
                if (var4 == 46) {
                    ...
                    TextureOperation12.outgoingBuffer.writeShortLE(Texture.lowestVisibleTileZ + var3);
                    TextureOperation12.outgoingBuffer.writeShort128LE(var2 + Class131.lowestVisibleTileX);
                ...
                if (var4 == 42) {
                    ...
                    TextureOperation12.outgoingBuffer.writeShortLE(var2 + Class131.lowestVisibleTileX);
                    TextureOperation12.outgoingBuffer.putShortA((int) (var6 >>> 32) & Integer.MAX_VALUE);
                    TextureOperation12.outgoingBuffer.writeShort(var3 - -Texture.lowestVisibleTileZ);
                }
                ...
                if (18 == var4) {
                    ...
                    TextureOperation12.outgoingBuffer.writeShortLE(Class131.lowestVisibleTileX + var2);
                    TextureOperation12.outgoingBuffer.writeShort(var5);
                    TextureOperation12.outgoingBuffer.writeShort128LE(var3 - -Texture.lowestVisibleTileZ);
                }
                ...
                if (var4 == 1006) {
                    ...
                    if (null != var13 && var13.amounts[var2] >= 100000) {
                        addChat(RSString.parse(""), 0, RSString.stringCombiner(new RSString[]{RSString.stringAnimator(var13.amounts[var2]), TextCore.aString_3777, ItemDefinition.getItemDefinition(var5).name}), -1);
                    } else {
                        TextureOperation12.outgoingBuffer.putOpcode(92);
                        TextureOperation12.outgoingBuffer.writeShort128LE(var5);
                    }
                ...
                if (var4 == 60) {
                    if (var5 == 0) {
                        ...
                        if (0 < Player.rights && ObjectDefinition.aBooleanArray1490[82] && ObjectDefinition.aBooleanArray1490[81]) {
                            Class30.method979(Class131.lowestVisibleTileX + var2, Texture.lowestVisibleTileZ + var3, WorldListCountry.localPlane);
                            ...
                            TextureOperation12.outgoingBuffer.writeShort(GraphicDefinition.yawTarget);
                ...
                if (49 == var4) {
                    ...
                    TextureOperation12.outgoingBuffer.writeShort128LE(Integer.MAX_VALUE & (int) (var6 >>> 32));
                    TextureOperation12.outgoingBuffer.writeShort128LE(Texture.lowestVisibleTileZ + var3);
                    TextureOperation12.outgoingBuffer.writeShortLE(var2 - -Class131.lowestVisibleTileX);
                }
                ...
                if (var4 == 14) {
                    ...
                    TextureOperation12.outgoingBuffer.putShortA(Class131.lowestVisibleTileX + var2);
                    TextureOperation12.outgoingBuffer.writeShort(Class164.anInt2050);
                    TextureOperation12.outgoingBuffer.writeShortLE(var3 - -Texture.lowestVisibleTileZ);
                    TextureOperation12.outgoingBuffer.writeShort(anInt1473);
                ...
                if (32 == var4) {
                    ...
                    if (34 == var4) {
                        ...
                        TextureOperation12.outgoingBuffer.writeShortLE(var3 - -Texture.lowestVisibleTileZ);
                        TextureOperation12.outgoingBuffer.writeShort(var2 + Class131.lowestVisibleTileX);
                        TextureOperation12.outgoingBuffer.writeShort128LE(var5);
                    }
                    ...
                    if (var4 == 51) {
                        ...
                        if (Objects.requireNonNull(var13).childDataBuffers != null && var13.childDataBuffers[0][0] == 5) {
                            ...
                            if (ItemDefinition.varp[var12] != var13.anIntArray307[0]) {
                                ItemDefinition.varp[var12] = var13.anIntArray307[0];
                                Class46.refreshMagicVarp(98, var12);
                            }
                        }
                    }
...
//							System.out.println(Class3_Sub28_Sub18.anInt3764 + ", " + Class110.anInt1473 + ", " + var5 + ", " + Class164.anInt2050);
                    ...
                    if (59 == var4) {
                        ...
                        if (Objects.requireNonNull(var13).childDataBuffers != null && var13.childDataBuffers[0][0] == 5) {
                            var12 = var13.childDataBuffers[0][1];
                            ItemDefinition.varp[var12] = -ItemDefinition.varp[var12] + 1;
                            Class46.refreshMagicVarp(68, var12);
                        }
                    }
                    ...
                    if (11 == var4) {
                        if (var5 == 0) {
                            ...
                            TextureOperation12.outgoingBuffer.putShortA(var3 + Texture.lowestVisibleTileZ);
                        }
                    }
                    ...
                    if (var4 == 24) {
                        ...
                        TextureOperation12.outgoingBuffer.putShortA(var2 - -Class131.lowestVisibleTileX);
                        TextureOperation12.outgoingBuffer.writeShort128LE(var5);
                        TextureOperation12.outgoingBuffer.writeShortLE(Texture.lowestVisibleTileZ + var3);
                    }
                    ...
                    if (var4 == 22) {
                        ...
                        if (var4 == 39) {
                            ...
                            TextureOperation12.outgoingBuffer.writeIntV1(anInt872);
                            TextureOperation12.outgoingBuffer.writeShort(Texture.lowestVisibleTileZ + var3);
                            TextureOperation12.outgoingBuffer.writeShort128LE(var5);
                            TextureOperation12.outgoingBuffer.writeShort128LE(var2 + Class131.lowestVisibleTileX);
                            TextureOperation12.outgoingBuffer.writeShortLE(RSInterface.anInt278);
                        }
                        ...
                        if (var4 == 36) {
                            if (var5 == 0) {
                                ...
                                Class30.method979(var2 + Class131.lowestVisibleTileX, Texture.lowestVisibleTileZ - -var3, WorldListCountry.localPlane);
                            } else {
                        ...
                        if (var4 == 20) {
                            ...
                            TextureOperation12.outgoingBuffer.writeShort(var5);
                            TextureOperation12.outgoingBuffer.writeShort(Class131.lowestVisibleTileX + var2);
                            TextureOperation12.outgoingBuffer.writeShortLE(Texture.lowestVisibleTileZ + var3);
                        }
                        ...
                        if (Class164_Sub1.anInt3012 != 0) {
                            Class164_Sub1.anInt3012 = 0;
                            Class20.flagUpdate(Unsorted.getRSInterface(Class3_Sub28_Sub18.anInt3764));
                        }
                        ...
                        if (Unsorted.aClass11_1933 != null && anInt2330 == 0) {
                            Class20.flagUpdate(Unsorted.aClass11_1933);
                        }
    ...
    final void readBytesIsaac(byte var1, int var2, byte[] var3, int var4) {
        try {
            if (var1 < 16) {
                addChat(null, 126, null, -28);
            }
    ...
    static void flagActiveInterfacesForUpdate() {
        try {
            Class3_Sub31 var1 = TextureOperation23.openInterfaces.first();
            for (; var1 != null; var1 = TextureOperation23.openInterfaces.next()) {
                int var2 = var1.widgetId;

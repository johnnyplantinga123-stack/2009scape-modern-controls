...
public final class SequenceDefinition {
	...
	static void resetAll() {
		try {
			...
			Class38_Sub1.systemUpdateTime = 0;
			...
			Class45.anInt733 = 0;
			GraphicDefinition.yawTarget = 2047 & (int)(Math.random() * 20.0D) - 10;
			Class58.anInt909 = -1;
			Class159.localPlayerCount = 0;
			Class161.minimapState = 0;
			...
			CS2Script.contactServerState = 0;
			Class8.totalFriendCount = 0;
			TextureOperation6.resetTransientVarP(-114);
			TileData.method103();
			Class75.anInt1105 = 0;
			...
			if(ConfigInventoryDefinition.parentWidgetId != -1) {
				Class60.method1208((byte)-128, ConfigInventoryDefinition.parentWidgetId);
			}

			for(Class3_Sub31 var7 = TextureOperation23.openInterfaces.first(); var7 != null; var7 = TextureOperation23.openInterfaces.next()) {
				TextureOperation19.closeWidget(true, var7);
			}

			ConfigInventoryDefinition.parentWidgetId = -1;
			TextureOperation23.openInterfaces = new HashTable(8);
			...
			for(var1 = 0; 8 > var1; ++var1) {
				Class91.playerOptions[var1] = null;
				Class1.secondaryOption[var1] = false;
				TextureOperation35.playerOptCursor[var1] = -1;
			}
			...
			for(var1 = 0; var1 < 25; ++var1) {
				TextureOperation17.level[var1] = 0;
				Class3_Sub20.maxLevel[var1] = 0;
				Class133.experience[var1] = 0;
			}

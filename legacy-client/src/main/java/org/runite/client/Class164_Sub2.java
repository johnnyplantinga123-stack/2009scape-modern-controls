...
public class Class164_Sub2 extends Class164 {
         ...
         if(var2.childDataBuffers != null && var2.childDataBuffers.length > var1) {
            try {
               ...
               while(true) {
                  ...
                  if(var8 == 1) {
                     var9 = TextureOperation17.level[var4[var6++]];
                  }
                  ...
                  if(var8 == 2) {
                     var9 = Class3_Sub20.maxLevel[var4[var6++]];
                  }

                  if(var8 == 3) {
                     var9 = Class133.experience[var4[var6++]];
                  }
                  ...
                  if(var8 == 4) {
                     ...
                     if(-1 != var13 && (!ItemDefinition.getItemDefinition(var13).membersItem || Unsorted.isMember)) {
                        for(var14 = 0; var14 < Objects.requireNonNull(var12).itemIds.length; ++var14) {
                           if(1 + var13 == var12.itemIds[var14]) {
                              var9 += var12.amounts[var14];
                           }
                        }
                     }
                  }
                  ...
                  if(var8 == 5) {
                     var9 = ItemDefinition.varp[var4[var6++]];
                  }

                  if(6 == var8) {
                     System.out.println(ItemDefinition.levelxpLookup[-1 + Class3_Sub20.maxLevel[var4[var6++]]]);
                     var9 = ItemDefinition.levelxpLookup[-1 + Class3_Sub20.maxLevel[var4[var6++]]];
                  }

                  if(var8 == 7) {
                     var9 = 100 * ItemDefinition.varp[var4[var6++]] / 0xb71b;
                  }
                  ...
                  if(9 == var8) {
                     for(var11 = 0; var11 < 25; ++var11) {
                        if(Class3_Sub23.aBooleanArray2538[var11]) {
                           var9 += Class3_Sub20.maxLevel[var11];
                        }
                     }
                  }
                  ...
                  if(var8 == 11) {
                     var9 = Unsorted.runEnergy;
                  }

                  if(12 == var8) {
                     var9 = MouseListeningClass.runWeight;
                  }

                  if(var8 == 13) {
                     var11 = ItemDefinition.varp[var4[var6++]];
                     int var17 = var4[var6++];
                  ...
                  if(var8 == 18) {
                     var9 = (Class102.player.xAxis >> 7) - -Class131.lowestVisibleTileX;
                  }

                  if(var8 == 19) {
                     var9 = (Class102.player.yAxis >> 7) - -Texture.lowestVisibleTileZ;
                  }
   ...
   static void method2249(int var1) {
      try {
         Linkable var2 = Class124.widgetSettings.first();

          for(; var2 != null; var2 = Class124.widgetSettings.next()) {

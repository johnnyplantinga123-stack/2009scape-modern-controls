   ...
   public static AbstractSprite constructItemSprite(int var0, boolean useHDSprite, int itemID, boolean var4, int outlineType, int itemCount, boolean shrinkInSprite) {
       try {
           ...
           if (null == var21) {
               ...
               int var18 = Class51.anIntArray851[item.iconPitch] * var16 >> 16;
               int var17 = Class51.anIntArray840[item.iconPitch] * var16 >> 16;
               var21.method1893(item.iconYAw, item.anInt768, item.iconPitch, item.anInt792, var17 - (var21.method1871() / 2 + -item.anInt754), item.anInt754 + var18);
               if (outlineType >= 1) {
                   var15.method657(1);
                   if (outlineType >= 2) {

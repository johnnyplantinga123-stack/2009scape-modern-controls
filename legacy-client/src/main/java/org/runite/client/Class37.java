...
final class Class37 {
    ...
    final void method1021() {
        ...
        if (HDToolKit.supportVertexBufferObject) {
            ...
            var1.glInterleavedArrays(GL2.GL_C4UB_V3F, 16, 0L);
            HDToolKit.aBoolean1798 = false;
            this.aClass156_646.method2171();
            var1.glDrawElements(4, this.anInt655, GL2.GL_UNSIGNED_INT, 0L);
        } else {

            var1.glInterleavedArrays(GL2.GL_C4UB_V3F, 16, this.aByteBuffer647);
            HDToolKit.aBoolean1798 = false;
            var1.glDrawElements(4, this.anInt655, GL2.GL_UNSIGNED_INT, this.aByteBuffer652);
        }

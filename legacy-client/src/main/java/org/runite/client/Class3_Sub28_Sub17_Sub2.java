...
public final class Class3_Sub28_Sub17_Sub2 extends Font {
   ...
   final void method678(int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      if(Class22.aHDSprite_447 == null) {
         ...
         var8.glActiveTexture(GL2.GL_TEXTURE1);
         var8.glEnable(GL2.GL_TEXTURE_2D);
         var8.glBindTexture(GL2.GL_TEXTURE_2D, var13.anInt4077);
         var8.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_COMBINE_RGB, GL2.GL_REPLACE);
         var8.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC0_RGB, GL2.GL_PREVIOUS);
         ...
         var8.glBegin(GL2.GL_TRIANGLE_FAN);
         var8.glMultiTexCoord2f(GL2.GL_TEXTURE1, var16, var15);
         var8.glTexCoord2f(var11, var10);
         var8.glVertex2f((float)this.anIntArray3709[var1], 0.0F);
         var8.glMultiTexCoord2f(GL2.GL_TEXTURE1, var14, var15);
         var8.glTexCoord2f(var9, var10);
         var8.glVertex2f(0.0F, 0.0F);
         var8.glMultiTexCoord2f(GL2.GL_TEXTURE1, var14, var17);
         var8.glTexCoord2f(var9, var12);
         var8.glVertex2f(0.0F, (float)(-this.anIntArray3721[var1]));
         var8.glMultiTexCoord2f(GL2.GL_TEXTURE1, var16, var17);
         var8.glTexCoord2f(var11, var12);
         var8.glVertex2f((float)this.anIntArray3709[var1], (float)(-this.anIntArray3721[var1]));
         var8.glEnd();
         var8.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_COMBINE_RGB, GL2.GL_MODULATE);
         var8.glTexEnvi(GL2.GL_TEXTURE_ENV, GL2.GL_SRC0_RGB, GL2.GL_TEXTURE);
         var8.glDisable(GL2.GL_TEXTURE_2D);
         var8.glActiveTexture(GL2.GL_TEXTURE0);
      }
       var8.glLoadIdentity();
   ...
   private void method707() {
      if(this.anIntArray4085 == null) {
         ...
         for(int var2 = 0; var2 < 256; ++var2) {
            ...
            var1.glNewList(this.anIntArray4085[var2], GL2.GL_COMPILE);
            var1.glBegin(GL2.GL_TRIANGLE_FAN);
   ...
   private void method708(byte[][] var1) {
      if(this.anInt4084 == -1) {
         ...
         HDToolKit.bindTexture2D(this.anInt4084);
         var15.glTexImage2D(GL2.GL_TEXTURE_2D, 0, GL2.GL_LUMINANCE_ALPHA, this.anInt4087, this.anInt4087, 0, GL2.GL_LUMINANCE_ALPHA, GL2.GL_UNSIGNED_BYTE, var14);
         Class31.memory2D += var14.limit() - this.anInt4083;
         this.anInt4083 = var14.limit();
         var15.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MIN_FILTER, GL2.GL_NEAREST);
         var15.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MAG_FILTER, GL2.GL_NEAREST);
      }
   }
}

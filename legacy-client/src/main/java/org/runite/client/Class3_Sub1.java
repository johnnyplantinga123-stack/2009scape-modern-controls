...
final class Class3_Sub1 extends Linkable {
    ...
    final boolean method92(int var1, byte var2) {
        try {
            return 0 != (this.accessMask >> 1 + var1 & 1);
        } catch (RuntimeException var4) {
    ...
    final boolean method93() {
        try {
            return 0 != (572878952 & this.accessMask) >> 29;
    ...
    final boolean method99() {
        try {
            ...
            return (1738913629 & this.accessMask) >> 30 != 0;
        } catch (RuntimeException var3) {
    ...
    final boolean method100() {
        try {
            return (this.accessMask & 455226656) >> 28 != 0;
        } catch (RuntimeException var3) {

...
public final class AudioHandler {
    ...
    static SoundTrack[] soundEffects = new SoundTrack[50];
    static int[] soundEffectCoordinates = new int[50];

    public static void playMusic(int var1) {
        try {
    ...
    public static void playSfx(int soundEffectVolume, int soundEffectID, int soundEffectDelay) {
        try {
        ...
        try {
            for (int var1 = 0; var1 < currentSoundEffectCount; ++var1) {
                ...
                if (soundEffectDelayArray[var1] < -10) {
                    ...
                    SoundTrack var11 = soundEffects[var1];
                    if (null == var11) {
                        var11 = SoundTrack.create(CacheIndex.soundFXIndex, soundEffectIDs[var1], 0);
                        if (null == var11) {
                            continue;
                        }

                        soundEffectDelayArray[var1] += var11.trim();
    ...
    public static void playJingle(int var1) {
        try {

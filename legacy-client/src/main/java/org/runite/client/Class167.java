...
public final class Class167 {
    ...
    public static RSString aString_2083 = null;
    ...
    static void method2263(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        var7.anInt1544 = var5;
        var7.anInt1548 = var6;
        Class3_Sub28_Sub8.aClass113Array3610[Scenery.anInt2249++] = var7;
    }

    static void method2264(boolean var0) {
        if (var0) {
            TileData.aTileDataArrayArrayArray2638 = Class166.aTileDataArrayArrayArray2065;
            ...
            TileData.aTileDataArrayArrayArray2638 = Unsorted.aTileDataArrayArrayArray4070;
        ...
        Class3_Sub17.anInt2456 = TileData.aTileDataArrayArrayArray2638.length;
    }
    ...
    static void method2267(int var0, int var1, boolean var2, DataBuffer var3, int var4, int var5, byte var6, int var7, int var8) {
        try {
            ...
            if (var5 >= 0 && var5 < 104 && var4 >= 0 && var4 < 104) {
                if (!var2) {
                    Unsorted.sceneryTypeMaskGrid[var8][var5][var4] = 0;
                }
                ...
                while (true) {
                    ...
                    if (49 >= var9) {
                        ...
                        Unsorted.sceneryTypeMaskGrid[var8][var5][var4] = (byte) (var9 - 49);
                    }
                }
            } else {
                while (true) {
    ...
    static int method2268(byte var0, int var1, int var2) {
        try {
            RSContainer var3 = (RSContainer) TileData.containerTable.get(var1);
            if (var3 == null) {
                return 0;
            } else if (var2 == -1) {
                return 0;
                ...
                for (int var5 = 0; var3.amounts.length > var5; ++var5) {
                    if (var3.itemIds[var5] == var2) {
                        var4 += var3.amounts[var5];
                    }
                }
                return var4;
            }
    ...
    static void logoutReset(byte var0) {
        try {
            ...
            Texture.lowestVisibleTileZ = 0;
            Unsorted.viewportX = 0;
            Class3_Sub7.viewportY = 0;
            Class131.lowestVisibleTileX = 0;

            for (var1 = 0; ClientErrorException.hintMapMarkers.length > var1; ++var1) {
                ClientErrorException.hintMapMarkers[var1] = null;
            }
            ...
            TextureOperation6.resetTransientVarP(var0 + -161);

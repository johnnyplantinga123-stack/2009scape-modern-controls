...
public final class Texture {
    ...
    public static int lowestVisibleTileZ;
            ...
            for (var7 = -1; var7 < Class159.localPlayerCount + Class163.localNPCCount; ++var7) {
                ...
                if (null != var8 && var8.hasDefinitions()) {
                    ...
                    if (var7 < Class159.localPlayerCount) {
                        ...
                        if (var7 >= 0) {
                            Class96[] var11 = ClientErrorException.hintMapMarkers;

                            for (var12 = 0; var12 < var11.length; ++var12) {
                                Class96 var13 = var11[var12];
                                if (null != var13 && var13.type == 10 && Class56.localPlayerIndexes[var7] == var13.actorTargetId) {
                                    Class107.method1647(var4 >> 1, var3, var8, var5, var8.method1975(var6 ^ -28716) - -15, var1 >> 1);
                                    if (Class32.anInt590 > -1) {
                                        Class166.hint_headicons[var13.anInt1351].drawAt(var2 - (-Class32.anInt590 + 12), var0 + (anInt2208 - var19));
                                    }
                                }
                            }
                        }
                        ...
                        Class96[] var20 = ClientErrorException.hintMapMarkers;

                        for (var21 = 0; var20.length > var21; ++var21) {
                            Class96 var24 = var20[var21];
                            if (null != var24 && var24.type == 1 && AudioThread.localNPCIndexes[-Class159.localPlayerCount + var7] == var24.actorTargetId && Class44.anInt719 % 20 < 10) {
                                if (-1 == var9.anInt1265) {
                                ...
                                if (Class32.anInt590 > -1) {
                                    Class166.hint_headicons[var24.anInt1351].drawAt(-12 + var2 + Class32.anInt590, -28 + anInt2208 + var0);
                                }
                            }
                        }
                    }
            ...
            for (; TextureOperation8.anInt3464 > var7; ++var7) {
                ...
                if (Unsorted.anInt688 == 0) {
                    ...
                    if (8 == anIntArray3331[var7]) {
                        var32 = CSConfigCachefile.anInt1127 % 20 >= 10 ? 8454016 : 0xb000;
                    }

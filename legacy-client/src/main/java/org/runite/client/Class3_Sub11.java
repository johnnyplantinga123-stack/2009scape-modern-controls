    ...
    final void method149(TileData[][][] var1, float var2, boolean var3) {
        ...
        if (aClass3_Sub30_2372.index != 0 || aClass3_Sub30_2362.index != 0) {
            ...
            if (this.aClass156_2363 == null) {
                if (HDToolKit.supportVertexBufferObject) {
                    var10.glBindBuffer(GL2.GL_ARRAY_BUFFER, 0);
                }

                this.aByteBuffer2345.position(0);
                var10.glVertexPointer(3, GL2.GL_FLOAT, var11, this.aByteBuffer2345);
                this.aByteBuffer2345.position(12);
                var10.glColorPointer(4, GL2.GL_UNSIGNED_BYTE, var11, this.aByteBuffer2345);
                if (Class106.aBoolean1441) {
                    this.aByteBuffer2345.position(16);
                    var10.glNormalPointer(GL2.GL_FLOAT, var11, this.aByteBuffer2345);
                }

                this.aByteBuffer2345.position(28);
                var10.glTexCoordPointer(2, GL2.GL_FLOAT, var11, this.aByteBuffer2345);
                if (this.aBoolean2347) {
                    var10.glClientActiveTexture(WaterShader.method2252());
                    this.aByteBuffer2345.position(36);
                    var10.glTexCoordPointer(1, GL2.GL_FLOAT, var11, this.aByteBuffer2345);
                    var10.glClientActiveTexture(GL2.GL_TEXTURE0);
                }
            } else {
                this.aClass156_2363.method2169();
                var10.glVertexPointer(3, GL2.GL_FLOAT, var11, 0L);
                var10.glColorPointer(4, GL2.GL_UNSIGNED_BYTE, var11, 12L);
                if (Class106.aBoolean1441) {
                    var10.glNormalPointer(GL2.GL_FLOAT, var11, 16L);
                }

                var10.glTexCoordPointer(2, GL2.GL_FLOAT, var11, 28L);
                if (this.aBoolean2347) {
                    var10.glClientActiveTexture(WaterShader.method2252());
                    var10.glTexCoordPointer(1, GL2.GL_FLOAT, var11, 36L);
                    var10.glClientActiveTexture(GL2.GL_TEXTURE0);
                }
            }

            if (HDToolKit.supportVertexBufferObject) {
                var10.glBindBuffer(GL2.GL_ELEMENT_ARRAY_BUFFER, 0);
            }
            ...
            if (aClass3_Sub30_2372.index != 0) {
                ...
                var10.glDrawElements(4, aClass3_Sub30_2372.index / 4, GL2.GL_UNSIGNED_INT, aByteBuffer2368);
            }
            ...
            if (aClass3_Sub30_2362.index != 0) {
                ...
                var10.glDrawElements(4, aClass3_Sub30_2362.index / 4, GL2.GL_UNSIGNED_INT, aByteBuffer2361);

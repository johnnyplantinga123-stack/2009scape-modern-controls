...
public final class Class49 {
    ...
    static void reportError(String var0, Throwable var1) {
        try {
            ...
            Class64 var4 = TextureOperation30.signlink.method1439(false, new URL(TextureOperation30.signlink.gameApplet.getCodeBase(), "clienterror.ws?c=&u=" + PacketParser.localName37 + "&v1=" + Signlink.javaVendor + "&v2=" + Signlink.javaVersion + "&e=" + var3));
    ...
    static void method1127(int var0) {
        try {
            ...
            if (ConfigInventoryDefinition.parentWidgetId != -1) {
                Class52.method1160(-113, ConfigInventoryDefinition.parentWidgetId);
            }

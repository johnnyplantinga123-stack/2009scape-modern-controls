...
final class Class3_Sub22 extends Linkable {
   ...
   static void method403() {
      ...
      var0.glDisableClientState(GL2.GL_COLOR_ARRAY);
      HDToolKit.method1837(false);
      var0.glDisable(GL2.GL_DEPTH_TEST);
      var0.glPushAttrib(GL2.GL_FOG_BIT);
      var0.glFogf(GL2.GL_FOG_START, 3072.0F);
      ...
      var0.glEnableClientState(GL2.GL_COLOR_ARRAY);
      HDToolKit.method1846();
      var0.glEnable(GL2.GL_DEPTH_TEST);
      var0.glPopAttrib();

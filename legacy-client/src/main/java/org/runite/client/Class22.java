...
public final class Class22 {
    ...
    public static void resetClipping() {
        ...
        var0.glDisable(GL2.GL_SCISSOR_TEST);
        method921();
    }
    ...
    static void method926(int[] var0, int var1, int var2, int var3, int var4) {
        ...
        var5.glDisable(GL2.GL_BLEND);
        var5.glDisable(GL2.GL_ALPHA_TEST);
        var5.glDrawPixels(var3, var4, GL2.GL_BGRA, HDToolKit.aBoolean1790 ? GL2.GL_UNSIGNED_INT_8_8_8_8_REV : GL2.GL_UNSIGNED_BYTE, IntBuffer.wrap(var0));
        var5.glEnable(GL2.GL_ALPHA_TEST);
        var5.glEnable(GL2.GL_BLEND);
        var5.glPixelZoom(1.0F, 1.0F);
    }
    ...
    static void method928(int var0, int var1, int var2, int var3, int var4, int var5) {
        ...
        var10.glBegin(GL2.GL_LINE_LOOP);
    ...
    static void method929(int var0, int var1, int var2, int var3, int var4, int var5) {
        ...
        if (var10 != 0) {
            ...
            var25.glBegin(GL2.GL_TRIANGLE_FAN);
            if (var12 <= var11) {
    ...
    static void method931(int var0, int var1, int var2, int var3) {
        ...
        var4.glEnable(GL2.GL_SCISSOR_TEST);
    ...
    static void method932() {
        HDToolKit.gl.glClear(GL2.GL_COLOR_BUFFER_BIT | GL2.GL_DEPTH_BUFFER_BIT);
    }

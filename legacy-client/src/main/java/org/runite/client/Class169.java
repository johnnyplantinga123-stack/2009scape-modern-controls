...
final class Class169 {
    ...
    public Class169() {
        ...
        var1.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MIN_FILTER, GL2.GL_LINEAR);
        var1.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_MAG_FILTER, GL2.GL_LINEAR);
        var1.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_WRAP_S, GL2.GL_CLAMP_TO_EDGE);
        var1.glTexParameteri(GL2.GL_TEXTURE_2D, GL2.GL_TEXTURE_WRAP_T, GL2.GL_CLAMP_TO_EDGE);
    }
    ...
    final void method2282(LDIndexedSprite var1, int var2, int var3) {
        ...
        if (var7 != this.anInt2112) {
            ...
            var13.limit(16384);
            HDToolKit.bindTexture2D(this.anInt2108);
            var12.glTexImage2D(GL2.GL_TEXTURE_2D, 0, GL2.GL_ALPHA, 128, 128, 0, GL2.GL_ALPHA, GL2.GL_UNSIGNED_BYTE, var13);
    ...
    final void method2284() {
        ...
        if (this.aClass156_2105 == null) {
            ...
            var1.glDrawElements(4, 384, GL2.GL_UNSIGNED_INT, this.aByteBuffer2107);
        } else {
            this.aClass156_2105.method2171();
            var1.glDrawElements(4, 384, GL2.GL_UNSIGNED_INT, 0L);
        }

...
final class TextureOperation20 extends TextureOperation {
   ...
   static void method235() {
      try {
         ...
         if(Class38_Sub1.systemUpdateTime > 1) {
            --Class38_Sub1.systemUpdateTime;
         ...
         if(Class3_Sub28_Sub18.aBoolean3769) {
            ...
            if(Class143.gameStage == 30) {
                        ...
                        for(var4 = 0; aClass67_1443.anInt1018 > var4 && TextureOperation12.outgoingBuffer.index - var2 < 240; ++var4) {
                           ...
                           if(anInt1977 == var6 && var5 == Unsorted.anInt14) {
                              ...
                              if(Class3_Sub26.anInt2556 < 8 && var8 >= -32 && 31 >= var8 && -32 <= var9 && var9 <= 31) {
                                 ...
                                 TextureOperation12.outgoingBuffer.writeShort(Class3_Sub26.anInt2556 + 0xe000);
                                 if(var7) {
                                    TextureOperation12.outgoingBuffer.writeInt(Integer.MIN_VALUE);
                                 } else {
                                    TextureOperation12.outgoingBuffer.writeInt(var6 | var5 << 16);
               ...
               if(Unsorted.aBoolean4068 && 0 >= anInt2212) {
                  ...
                  TextureOperation12.outgoingBuffer.putShortA(Unsorted.pitchTarget);
                  TextureOperation12.outgoingBuffer.writeShortLE(GraphicDefinition.yawTarget);
               }
               ...
               if(Class143.gameStage == 30) {
                  ...
                  if(AbstractSprite.anInt3699 > 750) {
                     ...
                     for(queuedVarpIndex = Class3_Sub5.method115(true); queuedVarpIndex != -1; queuedVarpIndex = Class3_Sub5.method115(false)) {
                        Class46.refreshMagicVarp(40, queuedVarpIndex);
                        Class44.cs2_updatedVarP[Unsorted.bitwiseAnd(Class36.varpUpdateCount++, 31)] = queuedVarpIndex;
                     }
                     ...
                     for(InterfaceWidget var16 = Unsorted.popNextInterfaceWidget(); var16 != null; var16 = Unsorted.popNextInterfaceWidget()) {
                        ...
                        if(1 == var3) {
                           ...
                           if(var3 == 3) {
                              ...
                              if (Objects.requireNonNull(var20).modelType != var6 || nodeModelID != var20.mediaId || var8 != var20.anInt265) {
                                 var20.mediaId = nodeModelID;
                                 var20.anInt265 = var8;
                              ...
                              var20 = Unsorted.getRSInterface(var4);
                              if (var16.anInt3598 != Objects.requireNonNull(var20).pitch || var20.yawId != var16.anInt3597 || var20.scale != var16.anInt3596) {
                                 var20.pitch = var16.anInt3598;
                                 var20.scale = var16.anInt3596;
                                 var20.yawId = var16.anInt3597;
                                 if (-1 != var20.anInt192) {
                                    if (var20.anInt184 <= 0) {
                                       if (var20.defWidth > 0) {
                                          var20.scale = 32 * var20.scale / var20.defWidth;
                                       }
                                    } else {
                                       var20.scale = var20.scale * 32 / var20.anInt184;
                                    }
                                 }
                     ...
                     if(Class67.aClass11_1017 != null) {
                        Class20.flagUpdate(Class67.aClass11_1017);
                           ...
                           if(Class72.aBoolean1074 && 5 <= Class40.anInt677) {
                              if(Class67.aClass11_1017 == Class99.aClass11_1402 && PacketParser.anInt86 != anInt2701) {
                                 ...
                                 if(Client.method44(var17).method93()) {
                                    ...
                                    var17.amounts[var6] = var17.amounts[var5];
                                    var17.itemIds[var5] = -1;
                                    var17.amounts[var5] = 0;
                                 } else if (var18 == 1) {
                                    var6 = anInt2701;
                                    var5 = PacketParser.anInt86;
                                 ...
                                 while(true) {
                                    ...
                                    if(var26 == null) {
                                       ...
                                       if(Player.rights > 0 && ObjectDefinition.aBooleanArray1490[82] && ObjectDefinition.aBooleanArray1490[81] && 0 != Class29.anInt561) {
                                          ...
                                          Class30.method979(Class102.player.xOffsets2767[0] + Class131.lowestVisibleTileX, Class102.player.yOffsets2755[0] + Texture.lowestVisibleTileZ, var5);
                                       }

                                       if(Player.rights > 0 && ObjectDefinition.aBooleanArray1490[82] && ObjectDefinition.aBooleanArray1490[81]) {
                                          if(-1 != Class27.anInt515) {
                                             Class30.method979(Class131.lowestVisibleTileX + Class27.anInt515, Texture.lowestVisibleTileZ - -Unsorted.anInt999, WorldListCountry.localPlane);
                                          }
                                          ...
                                          if(Class27.anInt515 != -1) {
                                             ...
                                             TextureOperation12.outgoingBuffer.putShortA(Class131.lowestVisibleTileX + Class27.anInt515);
                                             TextureOperation12.outgoingBuffer.writeShort128LE(RSInterface.anInt278);
                                             TextureOperation12.outgoingBuffer.putShortA(Unsorted.anInt999 + Texture.lowestVisibleTileZ);
                                             Class36.anInt638 = 1;
                                          ...
                                          if(-1 != Class27.anInt515) {
                                             ...
                                             TextureOperation12.outgoingBuffer.writeShort(Texture.lowestVisibleTileZ + Unsorted.anInt999);
                                             TextureOperation12.outgoingBuffer.writeShort(Class27.anInt515 + Class131.lowestVisibleTileX);
                                             Unsorted.anInt2958 = 0;
                                             Class36.anInt638 = 1;
                                             Class70.anInt1053 = Class163_Sub1.anInt2993;
                                             Unsorted.anInt4062 = Class38_Sub1.anInt2614;
                                       ...
                                       if(Class133.cameraMode == 1) {
                                          Unsorted.method2086();
                                       } else if(Class133.cameraMode == 2) {
                                          CS2Script.method379();
                                       } else {

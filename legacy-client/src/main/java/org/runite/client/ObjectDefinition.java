...
public final class ObjectDefinition {
    ...
    public final ObjectDefinition method1685(int var1) {
        try {
            if (var1 != 0) {
            ...
            if (this.ConfigFileId != -1) {
                ...
                var2 = ItemDefinition.varp[this.ConfigId];
            }
            ...
            if (null != this.OriginalColors) {
                for (var9 = 0; this.OriginalColors.length > var9; ++var9) {
                    if (null != this.aByteArray1513 && this.aByteArray1513.length > var9) {
                        var13.method2016(this.OriginalColors[var9], TextureOperation16.aShortArray3110[255 & this.aByteArray1513[var9]]);
                    } else {
        ...
        try {
            ...
            if (1 == opcode) {
                ...
                for (int var6 = 0; var5 >= var6; ++var6) {
                    ...
                    if (65535 == this.ChildrenIds[var6]) {

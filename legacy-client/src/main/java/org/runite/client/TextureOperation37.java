            ...
            try {
               ...
               if(Unsorted.registryStage == 4) {
                  ...
                  for(response = 0; response < TextureOperation29.aStringArray3391.length; ++response) {
                     TextureOperation29.aStringArray3391[response] = Unsorted.decodeBase37(BufferedDataStream.incomingBuffer.readLong());
                  }
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            if(TextureOperation35.aByteArrayArray3335[var2] != null) {
               ...
               while(TextureOperation35.aByteArrayArray3335[var2].length > var16.index && 511 > var5) {
                  ...
                  int var8 = var7 >> 14;
                  int var9 = 63 & var7 >> 7;
                  int var11 = var9 + 64 * (Class3_Sub24_Sub3.regionIds[var2] >> 8) - Class131.lowestVisibleTileX;
                  int var10 = var7 & 63;
                  int var12 = var10 + -Texture.lowestVisibleTileZ + 64 * (255 & Class3_Sub24_Sub3.regionIds[var2]);

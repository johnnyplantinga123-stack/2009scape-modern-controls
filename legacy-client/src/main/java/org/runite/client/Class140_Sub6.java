...
final class Class140_Sub6 extends GameObject {
   ...
   static int genericCs2UpdateTime = 0;
   int anInt2907;
   ...
   static void update9(int interfaceHash, int amount, int itemId) {
      try {
   ...
   Class140_Sub6(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      try {
         ...
         this.anInt2925 = var6;
         this.anInt2911 = var5;
         int var12 = GraphicDefinition.getGraphicDefinition(this.anInt2915).animationId;
         if(var12 == -1) {

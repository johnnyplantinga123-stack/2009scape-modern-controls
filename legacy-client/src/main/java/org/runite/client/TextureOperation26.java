...
final class TextureOperation26 extends TextureOperation {
   ...
   static void method195() {
      try {
         int regionX = (NPC.anInt3995 >> 10) - -(Class131.lowestVisibleTileX >> 3);
         int regionY = (Class77.anInt1111 >> 10) - -(Texture.lowestVisibleTileZ >> 3);
         byte plane = 0;
         byte sceneX = 8;
         byte var6 = 18;
   ...
   static void method198(boolean var0) {
      try {
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            byte[] var5 = var2[var4];
            if(var5 != null) {
               int var6 = -Class131.lowestVisibleTileX + 64 * (Class3_Sub24_Sub3.regionIds[var4] >> 8);
               int var7 = (Class3_Sub24_Sub3.regionIds[var4] & 0xFF) * 64 + -Texture.lowestVisibleTileZ;
               Class58.method1194();

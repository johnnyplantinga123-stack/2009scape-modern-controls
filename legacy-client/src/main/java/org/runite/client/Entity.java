...
public abstract class Entity extends GameObject {
    ...
    final void updateAnimationPosition(int var2, int newX, int newY, boolean var5) {
        try {
            if (this.animationId != -1 && SequenceDefinition.getAnimationDefinition(this.animationId).priority == 1) {
                this.animationId = -1;
            }
    ...
    final void walkStep(int var1, byte var2, int var3) {
        try {
            ...
            if (this.animationId != -1 && 1 == SequenceDefinition.getAnimationDefinition(this.animationId).priority) {
                this.animationId = -1;
            }

            ...
            for (int var3 = 0; var3 < var2.length; ++var3) {
                ...
                if (null != var4 && var1 == var4.parentId && (!var4.usingScripts || !Client.method51(var4))) {
                    if (var4.type == 0) {
                        ...
                        if (var5 != null) {
                            Class52.method1160(-111, var5.widgetId);
                        }
                    }
                    ...
                    if (var4.type == 6) {
                        ...
                        if (var4.animationId != -1 || var4.secondAnimationId != -1) {
                            ...
                            if (var6 != -1) {
                                ...
                                for (var4.anInt267 += Class106.anInt1446; var7.duration[var4.anInt283] < var4.anInt267; Class20.flagUpdate(var4)) {
                        ...
                        if (0 != var4.anInt237 && !var4.usingScripts) {
                            ...
                            var4.pitch = 2047 & var10 + var4.pitch;
                            var6 *= Class106.anInt1446;
                            var4.yawId = var4.yawId - -var6 & 0x7FF;
                            Class20.flagUpdate(var4);
                        }
                    }
                }
            }

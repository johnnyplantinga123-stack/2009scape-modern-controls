...
final class TextureOperation30 extends TextureOperation {
   ...
   static void method212(long var0) {
      try {
         if(0L != var0) {
            for(int var3 = 0; Class3_Sub28_Sub5.ignoreCount > var3; ++var3) {
               if(Class114.ignoreList[var3] == var0) {
                  --Class3_Sub28_Sub5.ignoreCount;

                  for(int var4 = var3; var4 < Class3_Sub28_Sub5.ignoreCount; ++var4) {
                     Class114.ignoreList[var4] = Class114.ignoreList[var4 + 1];

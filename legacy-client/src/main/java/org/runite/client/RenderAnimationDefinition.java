...
final class RenderAnimationDefinition {
    ...
    static void method900(Entity var0) {
        try {
            ...
            int var6;
            if (var0.graphicId != -1 && var0.gfxDelay <= Class44.anInt719) {
                var6 = GraphicDefinition.getGraphicDefinition(var0.graphicId).animationId;
                if (var6 == -1) {
                    var0.graphicId = -1;
                } else {
            ...
            if (var0.animationId != -1 && var0.anInt2828 <= 1) {
                var2 = SequenceDefinition.getAnimationDefinition(var0.animationId);

...
public final class Class39 {
    ...
    public static void parseMapRegion(boolean dynamic) {
        try {
            ...
            if (LinkableRSString.isDynamicSceneGraph) {
                ...
                numRegions = (-BufferedDataStream.incomingBuffer.index + Unsorted.packetSize) / 16;
                ...
                numRegions = (Unsorted.packetSize - BufferedDataStream.incomingBuffer.index) / 16;
                regionXteaKeys = new int[numRegions][4];
    ...
    static void parseLocationPacket(byte var0) {
        try {
            int var1;
            int var2;
            int var3;
            ...
            if (Unsorted.packetOpcode == 195) {
            ...
            } else if (Unsorted.packetOpcode == 33) {
                // ConstructGroundItem
                ...
                if (var3 >= 0 && var4 >= 0 && 104 > var3 && var4 < 104) {
                    ...
                    Class128.updateGroundItems(var4, var3);
                }
                ...
                } else if (Unsorted.packetOpcode == 17) {
                    // PositionedGraphic
                    var1 = BufferedDataStream.incomingBuffer.readUnsignedByte();
                ...
                } else if (Unsorted.packetOpcode == 179) {
                    // ConstructScenery
                ...
                } else if (Unsorted.packetOpcode == 20) {
                    // AnimateObject
                    ...
                    if (Unsorted.packetOpcode == 14) {
                        ...
                        if (0 <= var2 && var3 >= 0 && var2 < 104 && var3 < 104) {
                            ...
                            if (var29 != null) {
                                ...
                                Class128.updateGroundItems(var3, var2);
                            }
                        }

                    } else if (135 == Unsorted.packetOpcode) {
                        ...
                        } else if (Unsorted.packetOpcode == 104) {
                            var1 = BufferedDataStream.incomingBuffer.readUnsignedByte();
                        ...
                        } else if (97 == Unsorted.packetOpcode) {
                        ...
                        } else if (Unsorted.packetOpcode == 240) {
                            // ClearGroundItem
                            var1 = BufferedDataStream.incomingBuffer.readUnsigned128Byte();
                            var3 = currentChunkY + (var1 & 7);

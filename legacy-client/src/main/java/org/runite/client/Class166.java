...
final class Class166 {
    ...
    static AbstractSprite[] hint_headicons;
    static int[] cameraAmplitude = new int[5];
    ...
    static void method2258(int var0, RSString var2) {
        try {
            ...
            if (!var4) {
                BufferedDataStream.addChat(RSString.parse(""), 0, RSString.stringCombiner(new RSString[]{TextCore.HasUnableFind, var3}), -1);
            }

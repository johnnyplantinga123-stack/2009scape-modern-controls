      ...
      try {
         if(NPCDefinition.anInt1252 != -1 && anInt2293 != -1) {
            ...
            if(var0 == 65535) {
               ...
               NPC.anInt3995 = (int)var3[0] + -(128 * Class131.lowestVisibleTileX);
               Class77.anInt1111 = (int)var3[2] + -(Texture.lowestVisibleTileZ * 128);
               ...
               Class139.cameraPitch = 2047 & (int)(325.949D * (double) aFloat1169);
               TextureOperation28.cameraYaw = 2047 & (int)((double)Class45.aFloat730 * 325.949D);
            }
         }

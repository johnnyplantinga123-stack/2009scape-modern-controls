...
final class TextureOperation7 extends TextureOperation {
   ...
   static void method297(long var0, int var2) {
      try {
         if(var0 != 0L) {
            for(int var3 = 0; Class8.totalFriendCount > var3; ++var3) {
               if(var0 == Class50.friendNameLong[var3]) {
                  --Class8.totalFriendCount;

                  for(int var4 = var3; var4 < Class8.totalFriendCount; ++var4) {
                     Class70.friendNameString[var4] = Class70.friendNameString[var4 - -1];
                     Unsorted.friendWorldId[var4] = Unsorted.friendWorldId[var4 + 1];
                     Unsorted.friendWorldName[var4] = Unsorted.friendWorldName[1 + var4];
                     Class50.friendNameLong[var4] = Class50.friendNameLong[1 + var4];
   ...
   static void method299(int var0, int var1, int var2) {
      try {
         ...
         TextureOperation12.outgoingBuffer.writeShort(Class131.lowestVisibleTileX + var4);
         TextureOperation12.outgoingBuffer.putShortA(Texture.lowestVisibleTileZ + var5);
         Class45.anInt733 = Class45.anIntArray729[0];
         Class65.mapFlagX = TextureOperation38.anIntArray3456[0];

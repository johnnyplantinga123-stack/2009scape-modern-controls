...
object GameConfig {
    ...
    fun parse(path: String){
        ...
        if(data.containsKey("customization")){
            ...
            if(custom.containsKey("minimap_filter")) MINIMAP_FILTER = custom["minimap_filter"] as Boolean
            if(custom.containsKey("aa_samples")) AA_SAMPLES = custom["aa_samples"].toString().toInt()

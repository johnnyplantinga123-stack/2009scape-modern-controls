...
public final class client extends GameShell {
	...
	protected final void mainLoop() {
		...
		if (gameState == 10) {
			...
			// Central modern-control dispatcher. Phase 1 only implements the
			// camera-mode framework; the controller itself no-ops in later
			// phases until first/third-person movement is added.
